# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.h" 1
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.h" 1
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
...
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
...
# 18 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/move.h" 1
# 19 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
...
# 21 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
...
# 22 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c" 2
...
static signgroup_T * sign_group_ref(const char_u *groupname)
{
  ...
  if (((hi)->hi_key == ((void*)0) || (hi)->hi_key == (char_u *)&hash_removed)) {
    ...
    __builtin___strcpy_chk ((char *)(group->sg_name), (char *)(groupname), __builtin_object_size ((char *)(group->sg_name), 1 > 1 ? 1 : 0));
    group->sg_refcount = 1;
    group->sg_next_sign_id = 1;
    hash_add_item(&sg_table, hi, group->sg_name, hash);
  } else {

    group = ((signgroup_T *)((hi)->hi_key - __builtin_offsetof(signgroup_T, sg_name)));
    group->sg_refcount++;
  }
...
{
    return ((group != ((void*)0) && strcmp((char *)(group), (char *)("*")) == 0)
            || (group == ((void*)0) && sign->se_group == ((void*)0))
            || (group != ((void*)0) && sign->se_group != ((void*)0)
...
)
{
  ...
  while (prev != ((void*)0) && prev->se_lnum == lnum
...
dict_T * sign_get_info(sign_entry_T *sign)
{
  ...
  tv_dict_add_str(d, ("group"), (sizeof("group") - 1), ((sign->se_group == ((void*)0))
                                      ? (char *)""
...
# 429 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c"
                             ...
                             int idx, int max_signs)
{
    ...
    for (int i = 0; i < 9; i++) {
        if ( (type == SIGN_TEXT && sattrs[i].sat_text != ((void*)0))
...
int buf_get_signattrs(buf_T *buf, linenr_T lnum, sign_attrs_T sattrs[])
{
    ...
    for (sign = buf->b_signlist; sign != ((void*)0); sign = sign->se_next) {
        ...
        if (sign->se_lnum == lnum) {
            sign_attrs_T sattr;
            __builtin___memset_chk (&sattr, 0, sizeof(sattr), __builtin_object_size (&sattr, 0));
            sattr.sat_typenr = sign->se_typenr;
            sp = find_sign_by_typenr(sign->se_typenr);
            if (sp != ((void*)0)) {
                sattr.sat_text = sp->sn_text;
                if (sattr.sat_text != ((void*)0) && sp->sn_text_hl != 0) {
...
# 525 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c"
...
)
{
  ...
  lnum = 0;
  for (sign = buf->b_signlist; sign != ((void*)0); sign = next) {
    next = sign->se_next;
...
void buf_delete_signs(buf_T *buf, char_u *group)
{
    ...
    if (buf->b_signlist != ((void*)0) && curwin != ((void*)0)) {
      changed_line_abv_curs();
    }
...
void sign_list_placed(buf_T *rbuf, char_u *sign_group)
{
  ...
  while (buf != ((void*)0) && !got_int) {
    if (buf->b_signlist != ((void*)0)) {
      vim_snprintf(lbuf, 480, libintl_gettext((char *)("Signs for %s:")), buf->b_fname);
    ...
    for (sign = buf->b_signlist; sign != ((void*)0); sign = sign->se_next) {
      ...
      if (sign->se_group != ((void*)0)) {
        vim_snprintf(group, 480, libintl_gettext((char *)("  group=%s")),
                     sign->se_group->sg_name);
      } else {
        group[0] = '\0';
      }
      vim_snprintf(lbuf, 480,
                   libintl_gettext((char *)("    line=%ld  id=%d%s  name=%s  priority=%d")),
...
)
{
  sign_entry_T *sign;
  sign_entry_T *next;
  sign_entry_T *last = ((void*)0);
  sign_entry_T **lastp = ((void*)0);
  linenr_T new_lnum;
  int is_fixed = 0;
  ...
  for (sign = curbuf->b_signlist; sign != ((void*)0); sign = next) {
    next = sign->se_next;
...
static int sign_define_init_text(sign_T *sp, char_u *text)
{
  ...
  if (s != endp || cells > 2) {
    emsgf((const char *) (libintl_gettext((char *)("E239: Invalid sign text: %s"))), (text));
    return 0;
  }
  if (cells < 1) {
    sp->sn_text = ((void*)0);
...
)
{
  ...
  if (sp == ((void*)0)) {
    ...
    for (win_T *wp = ((curtab) == curtab) ? firstwin : (curtab)->tp_firstwin; wp != ((void*)0); wp = wp->w_next) {
      if (wp->w_buffer->b_signlist != ((void*)0)) {
  ...
  if (text != ((void*)0) && (sign_define_init_text(sp, text) == 0)) {
    return 0;
  }
...
int sign_undefine_by_name(const char_u *name)
{
  ...
  sp = sign_find(name, &sp_prev);
  if (sp == ((void*)0)) {
    emsgf((const char *) (libintl_gettext((char *)("E155: Unknown sign: %s"))), (name));
    return 0;
  }
...
)
{
  ...
  if (sign_group != ((void*)0) && (*sign_group == '*' || *sign_group == '\0')) {
    return 0;
  }
  ...
  if (lnum > 0) {
    ...
    _Bool has_text_or_icon = sp->sn_text != ((void*)0) || sp->sn_icon != ((void*)0);
    buf_addsign(
        buf,
        *sign_id,
        sign_group,
  ...
  if (lnum > 0) {
    ...
    may_force_numberwidth_recompute(buf, 0);
  } else {
...
int sign_unplace(int sign_id, char_u *sign_group, buf_T *buf, linenr_T atlnum)
{
  ...
  if (buf->b_signlist == ((void*)0)) {
    may_force_numberwidth_recompute(buf, 1);
  }
...
linenr_T sign_jump(int sign_id, char_u *sign_group, buf_T *buf)
{
  ...
  if ((lnum = buf_findsign(buf, sign_id, sign_group)) <= 0) {
    emsgf((const char *) (libintl_gettext((char *)("E157: Invalid sign ID: %" "ll" "d"))), (int64_t)(sign_id));
    return -1;
  }
...
static void sign_define_cmd(char_u *sign_name, char_u *cmdline)
{
  ...
  char_u *icon = ((void*)0);
  char_u *text = ((void*)0);
  char_u *linehl = ((void*)0);
  char_u *texthl = ((void*)0);
  char_u *numhl = ((void*)0);
  int failed = 0;
...
{
  if (id <= 0) {
# 1217 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c"
    if (lnum >= 0 || sign_name != ((void*)0)
        || (group != ((void*)0) && *group == '\0')) {
    ...
    if (sign_name == ((void*)0) || buf == ((void*)0)
        || (group != ((void*)0) && *group == '\0')) {
      emsg((char_u *)(libintl_gettext((char *)(e_invarg))));
      return;
    }
...
{
    if (lnum >= 0 || sign_name != ((void*)0) || (group != ((void*)0) && *group == '\0')) {
      emsg((char_u *)(libintl_gettext((char *)(e_invarg))));
      return;
    }
    ...
    if (id == -2) {
      if (buf != ((void*)0)) {
        ...
        for (buf_T *cbuf = firstbuf; cbuf != ((void*)0); cbuf = cbuf->b_next) {
          if (cbuf->b_signlist != ((void*)0)) {
...
{
  if (sign_name == ((void*)0) && group == ((void*)0) && id == -1) {
    emsg((char_u *)(libintl_gettext((char *)(e_argreq))));
    return;
  }

  if (buf == ((void*)0) || (group != ((void*)0) && *group == '\0')
      || lnum >= 0 || sign_name != ((void*)0)) {
...
)
{
  ...
  while (*arg != '\000') {
    if (strncmp((char *)(arg), (char *)("line="), (size_t)(5)) == 0) {
      ...
      *buf = buflist_findname_exp(arg);
      ...
      arg += 7;
      filename = arg;
      *buf = buflist_findnr(getdigits_int(&arg, 1, 0));
  ...
  if (filename != ((void*)0) && *buf == ((void*)0)) {
    emsgf((const char *) (libintl_gettext((char *)("E158: Invalid buffer name: %s"))), (filename));
    return 0;
  }



  if (filename == ((void*)0) && ((cmd == 3 && lnum_arg)
                           || cmd == 5)) {
    *buf = curwin->w_buffer;
  }
  return 1;
...
static void sign_getinfo(sign_T *sp, dict_T *retdict)
{
  ...
  if (sp->sn_line_hl > 0) {
    p = get_highlight_name_ext(((void*)0), sp->sn_line_hl - 1, 0);
    if (p == ((void*)0)) {
      p = "NONE";
    }
  ...
  if (sp->sn_text_hl > 0) {
    p = get_highlight_name_ext(((void*)0), sp->sn_text_hl - 1, 0);
    if (p == ((void*)0)) {
      p = "NONE";
    }
  ...
  if (sp->sn_num_hl > 0) {
    p = get_highlight_name_ext(((void*)0), sp->sn_num_hl - 1, 0);
    if (p == ((void*)0)) {
      p = "NONE";
    }
...
void sign_getlist(const char_u *name, list_T *retlist)
{
  ...
  for (; sp != ((void*)0) && !got_int; sp = sp->sn_next) {
    dict = tv_dict_alloc();
...
static void sign_list_defined(sign_T *sp)
{
  ...
  if (sp->sn_line_hl > 0) {
    msg_puts(" linehl=");
    const char *const p = get_highlight_name_ext(((void*)0),
                                                 sp->sn_line_hl - 1, 0);
    if (p == ((void*)0)) {
      msg_puts("NONE");
    } else {
...
{
  while (first_sign != ((void*)0)) {
    sign_undefine(first_sign, ((void*)0));
  }
}
...
static char_u *get_nth_sign_group_name(int idx)
{
  ...
  for (hashitem_T *hi = sg_table.ht_array; todo > 0; hi++) {
    if (!((hi)->hi_key == ((void*)0) || (hi)->hi_key == (char_u *)&hash_removed)) {
      todo--;
      if (current_idx++ == idx) {
        signgroup_T *const group = ((signgroup_T *)((hi)->hi_key - __builtin_offsetof(signgroup_T, sg_name)));
...
char_u * get_sign_name(expand_T *xp, int idx)
{
  switch (expand_what) {
    ...
    case EXP_LIST: {
      char *list_arg[] = { "group=", "file=", "buffer=", ((void*)0) };
      return (char_u *)list_arg[idx];
    }
    case EXP_UNPLACE: {
        char *unplace_arg[] = { "group=", "file=", "buffer=", ((void*)0) };
...
# 1809 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c"
...
int sign_define_from_dict(const char *name_arg, dict_T *dict)
{
  ...
  if (name_arg == ((void*)0)) {
    ...
    name = tv_dict_get_string(dict, "name", 1);
  } else {
  ...
  if (dict != ((void*)0)) {
    icon = tv_dict_get_string(dict, "icon" , 1);
    linehl = tv_dict_get_string(dict, "linehl", 1);
    text = tv_dict_get_string(dict, "text" , 1);
    texthl = tv_dict_get_string(dict, "texthl", 1);
    numhl = tv_dict_get_string(dict, "numhl" , 1);
  }
...
void sign_define_multiple(list_T *l, list_T *retlist)
{
    ...
    do { const list_T *const l_ = (l); ; if (l_ != ((void*)0)) { for (const listitem_T *li = l_->lv_first; li != ((void*)0); li = li->li_next) { { retval = -1; if ((&(li)->li_tv)->v_type == VAR_DICT) { retval = sign_define_from_dict(((void*)0), (&(li)->li_tv)->vval.v_dict); } else { emsg((char_u *)(libintl_gettext((char *)(e_dictreq)))); } tv_list_append_number(retlist, retval); } } } } while (0);
# 1956 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sign.c"
}
...
void sign_undefine_multiple(list_T *l, list_T *retlist)
{
  ...
  do { const list_T *const l_ = (l); ; if (l_ != ((void*)0)) { for (const listitem_T *li = l_->lv_first; li != ((void*)0); li = li->li_next) { { retval = -1; name = (char_u *)tv_get_string_chk((&(li)->li_tv)); if (name != ((void*)0) && (sign_undefine_by_name(name) == 1)) { retval = 0; } tv_list_append_number(retlist, retval); } } } } while (0);
...
int sign_unplace_from_dict(typval_T *group_tv, dict_T *dict)
{
  ...
  if (group_tv != ((void*)0)) {
    ...
    group = (char_u *)tv_dict_get_string(dict, "group", 0);
  }
  if (group != ((void*)0)) {
    if (group[0] == '\0') {
      group = ((void*)0);
  ...
  if (dict != ((void*)0)) {
    if ((di = tv_dict_find(dict, "buffer", -1)) != ((void*)0)) {
      buf = get_buf_arg(&di->di_tv);
      if (buf == ((void*)0)) {
        goto cleanup;
      }
    }
    if (tv_dict_find(dict, "id", -1) != ((void*)0)) {
