# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c" 2
...
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/os.h" 1
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c" 2
...
{
  (void)do_source(fname, 0, 0);
}
# 63 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c"
               ...
               DoInRuntimepathCB callback, void *cookie)
{
  ...
  {
    if (p_verbose > 10 && name != ((void*)0)) {
      verbose_enter();
      smsg(libintl_gettext((char *)("Searching for \"%s\" in \"%s\"")),
           (char *)name, (char *)path);
      verbose_leave();
    }
    ...
    while (*rtp != '\000' && ((flags & 0x01) || !did_one)) {
      ...
      if (name == ((void*)0)) {
        ...
        while (*np != '\000' && ((flags & 0x01) || !did_one)) {
          ...
          (__builtin_expect(!(4096 >= (tail - buf)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c", 115, "MAXPATHL >= (tail - buf)") : (void)0);
          copy_option_part(&np, tail, (size_t)(4096 - (tail - buf)),
                           "\t ");

          if (p_verbose > 10) {
            verbose_enter();
            smsg(libintl_gettext((char *)("Searching for \"%s\"")), buf);
            verbose_leave();
          }
  ...
  xfree(buf);
  xfree(rtp_copy);
  if (!did_one && name != ((void*)0)) {
    char *basepath = path == p_rtp ? "runtimepath" : "packpath";

    if (flags & 0x04) {
      emsgf((const char *) (libintl_gettext((char *)(e_dirnotf))), (basepath), (name));
    } else if (p_verbose > 0) {
      verbose_enter();
      smsg(libintl_gettext((char *)("not found in '%s': \"%s\"")), basepath, name);
      verbose_leave();
    }
  }
...
# 168 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c"
...
{
  return do_in_path_and_pp(path, name, flags, source_callback, ((void*)0));
}
...
static int add_pack_dir_to_rtp(char_u *fname)
{
  ...
  *p4 = c;
  ...
  const char *insp = ((void*)0);
  const char *after_insp = ((void*)0);
  for (const char *entry = (const char *)p_rtp; *entry != '\000'; ) {
    ...
    if (insp == ((void*)0)) {
      ...
      if (rtp_ffname == ((void*)0)) {
        goto theend;
      }
      _Bool match = path_fnamencmp(rtp_ffname, ffname, fname_len) == 0;
      xfree(rtp_ffname);
      if (match) {
    ...
    if ((p = (char_u *)strstr((char *)buf, "after")) != ((void*)0)
        && p > buf
        && vim_ispathsep(p[-1])
  ...
  afterdir = concat_fnames((char *)fname, "after", 1);
  size_t afterlen = 0;
  ...
  __builtin___memmove_chk (new_rtp, p_rtp, keep, __builtin_object_size (new_rtp, 0));
  size_t new_rtp_len = keep;
  if (*insp == '\000') {
    new_rtp[new_rtp_len++] = ',';
  }
  __builtin___memmove_chk (new_rtp + new_rtp_len, fname, addlen - 1, __builtin_object_size (new_rtp + new_rtp_len, 0));
  new_rtp_len += addlen - 1;
  if (*insp != '\000') {
    new_rtp[new_rtp_len++] = ',';
  }

  if (afterlen > 0 && after_insp != ((void*)0)) {
    size_t keep_after = (size_t)(after_insp - (const char *)p_rtp);


    __builtin___memmove_chk (new_rtp + new_rtp_len, p_rtp + keep, keep_after - keep, __builtin_object_size (new_rtp + new_rtp_len, 0));
    new_rtp_len += keep_after - keep;
    __builtin___memmove_chk (new_rtp + new_rtp_len, afterdir, afterlen - 1, __builtin_object_size (new_rtp + new_rtp_len, 0));
  ...
  if (p_rtp[keep] != '\000') {
    ...
    __builtin___memmove_chk (new_rtp + new_rtp_len, p_rtp + keep, oldlen - keep + 1, __builtin_object_size (new_rtp + new_rtp_len, 0));
  } else {
...
# 560 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c"
...
# 604 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c"
...
# 665 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c"
  ...
  FUNC_ATTR_NONNULL_RET FUNC_ATTR_NONNULL_ARG(1) FUNC_ATTR_WARN_UNUSED_RESULT
{
  ...
  dest = strcpy_comma_escaped(dest, dir, dir_len);
  _Bool append_nvim = (type == kXDGDataHome || type == kXDGConfigHome);
  if (append_nvim) {
    if (!after_pathsep(dest - 1, dest)) {
      *dest++ = '/';
    }
...
# 728 "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c"
char *runtimepath_default(_Bool clean_arg)
{
  ...
  rtp_cur = add_dir(rtp_cur, config_home, config_len, kXDGConfigHome,
                    ((void*)0), 0, ((void*)0), 0);
  rtp_cur = add_env_sep_dirs(rtp_cur, config_dirs, ((void*)0), 0, ((void*)0), 0, 1);
  rtp_cur = add_dir(rtp_cur, data_home, data_len, kXDGDataHome,
                    "site", (sizeof("site") - 1), ((void*)0), 0);
  rtp_cur = add_env_sep_dirs(rtp_cur, data_dirs, "site", (sizeof("site") - 1), ((void*)0), 0,
                             1);
  rtp_cur = add_dir(rtp_cur, vimruntime, vimruntime_len, kXDGNone,
                    ((void*)0), 0, ((void*)0), 0);
  rtp_cur = add_dir(rtp_cur, libdir, libdir_len, kXDGNone, ((void*)0), 0, ((void*)0), 0);
  ...
  rtp_cur = add_env_sep_dirs(rtp_cur, config_dirs, "after", (sizeof("after") - 1), ((void*)0), 0,
                             0);
  rtp_cur = add_dir(rtp_cur, config_home, config_len, kXDGConfigHome,
                    "after", (sizeof("after") - 1), ((void*)0), 0);

  rtp_cur[-1] = '\000';
  (__builtin_expect(!((size_t)(rtp_cur - rtp) == rtp_size), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/runtime.c", 812, "(size_t)(rtp_cur - rtp) == rtp_size") : (void)0);
