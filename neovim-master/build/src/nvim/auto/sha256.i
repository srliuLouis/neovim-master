# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.c" 2
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.c"
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.c" 2
...
# 18 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.h" 2
# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stddef.h" 1 3
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.h" 2
...
# 20 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.c" 2
...
# 21 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.c" 2
# 39 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.c"
...
# 99 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.c"
  A = ctx->state[0];
  B = ctx->state[1];
  C = ctx->state[2];
  D = ctx->state[3];
...
void sha256_update(context_sha256_T *ctx, const char_u *input, size_t length)
{
  ...
  if (left && (length >= fill)) {
    __builtin___memcpy_chk ((void *)(ctx->buffer + left), (void *)input, fill, __builtin_object_size ((void *)(ctx->buffer + left), 0));
  ...
  if (length) {
    __builtin___memcpy_chk ((void *)(ctx->buffer + left), (void *)input, length, __builtin_object_size ((void *)(ctx->buffer + left), 0));
  }
}
...
# 265 "/Users/shi-rongliu/tool/neovim-master/src/nvim/sha256.c"
                         ...
                         const uint8_t *restrict salt, size_t salt_len)
{
  ...
  for (size_t j = 0; j < 32; j++) {
    __builtin___snprintf_chk (hexit + j * 2, 2 + 1, 0, __builtin_object_size (hexit + j * 2, 1 > 1 ? 1 : 0), "%02x", sha256sum[j]);
  }
...
_Bool sha256_self_test(void)
{
  ...
  static _Bool sha256_self_tested = 0;
  static _Bool failures = 0;
  ...
  for (size_t i = 0; i < 3; i++) {
    if (i < 2) {
      hexit = sha256_bytes((uint8_t *)sha_self_test_msg[i],
                           ...
                           ((void*)0), 0);
      __builtin___strcpy_chk ((char *)(output), (char *)(hexit), __builtin_object_size ((char *)(output), 1 > 1 ? 1 : 0));
    } else {
      sha256_start(&ctx);
      __builtin___memset_chk (buf, 'a', 1000, __builtin_object_size (buf, 0));
      ...
      for (size_t j = 0; j < 32; j++) {
        __builtin___snprintf_chk (output + j * 2, 2 +1, 0, __builtin_object_size (output + j * 2, 1 > 1 ? 1 : 0), "%02x", sha256sum[j]);
      }
    }
