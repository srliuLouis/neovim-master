# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memory.h" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c" 2
...
# 19 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c" 2
...
# 22 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c" 2
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (host_end && addr != host_end) {
    ...
    *host_end = '\0';
    ...
    if (!ok || iport < 0 || iport > 65535) {
      logmsg(4, ((void*)0), __func__, 45, 1, "Invalid port: %s", port);
      return UV_EINVAL;
    }
    ...
    int retval = uv_getaddrinfo(&loop->uv, &request, ((void*)0), addr, port,
                                &(struct addrinfo){
                                  .ai_family = 0,
                                  .ai_socktype = 1,
                                });
    if (retval != 0) {
      logmsg(4, ((void*)0), __func__, 63, 1, "Host lookup failed: %s", endpoint);
      return retval;
    }
  ...
  watcher->cb = ((void*)0);
  watcher->close_cb = ((void*)0);
  watcher->events = ((void*)0);
  watcher->data = ((void*)0);
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (watcher->stream->type == UV_TCP) {
    ...
    for (; ai; ai = ai->ai_next) {
      ...
      if (result == 0) {
        ...
        __builtin___snprintf_chk (watcher->addr+len, sizeof(watcher->addr)-len, 0, __builtin_object_size (watcher->addr+len, 1 > 1 ? 1 : 0), ":%" "hu", ((__uint16_t)(__builtin_constant_p(port) ? ((__uint16_t)((((__uint16_t)(port) & 0xff00U) >> 8) | (((__uint16_t)(port) & 0x00ffU) << 8))) : _OSSwapInt16(port))));
  ...
  (__builtin_expect(!(result <= 0), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.c", 127, "result <= 0") : (void)0);
  if (result < 0) {
    if (result == UV_EACCES) {
  ...
  FUNC_ATTR_NONNULL_ARG(1) FUNC_ATTR_NONNULL_ARG(2)
{
  ...
  stream_init(((void*)0), stream, -1, client);
  return 0;
}
...
_Bool socket_connect(Loop *loop, Stream *stream,
                    _Bool is_tcp, const char *address,
                    int timeout, const char **error)
{
  ...
  addr_req.addrinfo = ((void*)0);
  const struct addrinfo *addrinfo = ((void*)0);
  char *addr = ((void*)0);
  if (is_tcp) {
    addr = xstrdup(address);
    char *host_end = strrchr(addr, ':');
    if (!host_end) {
      *error = libintl_gettext((char *)("tcp address must be host:port"));
      goto cleanup;
    }
    *host_end = '\000';

    const struct addrinfo hints = { .ai_family = 0,
                                    .ai_socktype = 1,
                                    .ai_flags = 0x00001000 };
    int retval = uv_getaddrinfo(&loop->uv, &addr_req, ((void*)0),
                                addr, host_end+1, &hints);
    if (retval != 0) {
      *error = libintl_gettext((char *)("failed to lookup host or port"));
      goto cleanup;
    }
...
tcp_retry:
  ...
  status = 1;
  do { int remaining = timeout; uint64_t before = (remaining > 0) ? os_hrtime() : 0; while (!(status != 1)) { do { if (((void*)0) && !multiqueue_empty(((void*)0))) { multiqueue_process_events(((void*)0)); } else { loop_poll_events(&main_loop, remaining); } } while (0); if (remaining == 0) { break; } else if (remaining > 0) { uint64_t now = os_hrtime(); remaining -= (int) ((now - before) / 1000000); before = now; if (remaining <= 0) { break; } } } } while (0);
  if (status == 0) {
    stream_init(((void*)0), stream, -1, uv_stream);
    success = 1;
  } else if (is_tcp && addrinfo->ai_next) {
    addrinfo = addrinfo->ai_next;
    goto tcp_retry;
  } else {
    *error = libintl_gettext((char *)("connection refused"));
  }
