# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.h" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
...
# 18 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c" 2
# 34 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c"
static _Bool process_is_tearing_down = 0;


int process_spawn(Process *proc, _Bool in, _Bool out, _Bool err)
  FUNC_ATTR_NONNULL_ALL
{
  if (in) {
  ...
  if (status) {
    if (in) {
      uv_close((uv_handle_t *)&proc->in.uv.pipe, ((void*)0));
    }
    if (out) {
      uv_close((uv_handle_t *)&proc->out.uv.pipe, ((void*)0));
    }
    if (err) {
      uv_close((uv_handle_t *)&proc->err.uv.pipe, ((void*)0));
    }

    if (proc->type == kProcessTypeUv) {
      uv_close((uv_handle_t *)&(((LibuvProcess *)proc)->uv), ((void*)0));
    } else {
      process_close(proc);
    }
...
# 163 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c"
...
static void children_kill_cb(uv_timer_t *handle)
{
  ...
  for (kl1_WatcherPtr **current = ((void*)0) ? ((void*)0) : &loop->children->head; *current != loop->children->tail; current = &(*current)->next) {
    ...
    uint64_t term_sent = 18446744073709551615ULL == proc->stopped_time;
    if (kProcessTypePty != proc->type || term_sent) {
      proc->exit_signal = 9;
      os_proc_tree_kill(proc->pid, 9);
    } else {
      proc->exit_signal = 15;
      os_proc_tree_kill(proc->pid, 15);
      proc->stopped_time = 18446744073709551615ULL;
...
static void decref(Process *proc)
{
  ...
  (__builtin_expect(!(node), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c", 292, "node") : (void)0);
  ...
  FUNC_ATTR_NONNULL_ARG(1)
{
  ...
  (__builtin_expect(!(!proc->closed), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.c", 306, "!proc->closed") : (void)0);
  proc->closed = 1;
  ...
  while (!stream->closed && stream->num_bytes < max_bytes) {
    ...
    if (num_bytes == stream->num_bytes) {
      if (stream->read_cb && !stream->did_eof) {
        ...
        stream->read_cb(stream, stream->buffer, 0, stream->cb_data, 1);
      }
      break;
    }
  }
