# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/loop.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/loop.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/loop.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/loop.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/loop.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/loop.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/loop.c" 2
...
void loop_init(Loop *loop, void *data)
{
  ...
  loop->thread_events = multiqueue_new_parent(((void*)0), ((void*)0));
  uv_mutex_init(&loop->mutex);
  uv_async_init(&loop->uv, &loop->async, async_cb);
  uv_signal_init(&loop->uv, &loop->children_watcher);
  uv_timer_init(&loop->uv, &loop->children_kill_timer);
  uv_timer_init(&loop->uv, &loop->poll_timer);
  loop->poll_timer.data = xmalloc(sizeof(_Bool));
}
# 44 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/loop.c"
_Bool loop_poll_events(Loop *loop, int ms)
{
  ...
  _Bool timeout_expired = 0;

  if (ms > 0) {
    *((_Bool *)loop->poll_timer.data) = 0;
  ...
  if (ms > 0) {
    timeout_expired = *((_Bool *)loop->poll_timer.data);
...
# 82 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/loop.c"
...
# 134 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/loop.c"
_Bool loop_close(Loop *loop, _Bool wait)
{
  _Bool rv = 1;
  uv_mutex_destroy(&loop->mutex);
  uv_close((uv_handle_t *)&loop->children_watcher, ((void*)0));
  uv_close((uv_handle_t *)&loop->children_kill_timer, ((void*)0));
  uv_close((uv_handle_t *)&loop->poll_timer, timer_close_cb);
  uv_close((uv_handle_t *)&loop->async, ((void*)0));
  ...
  while (1) {
    ...
    if (elapsed_s >= 2) {
      ...
      rv = 0;
      logmsg(4, ((void*)0), __func__, 155, 1, "uv_loop_close() hang?");
    ...
    if (!didstop) {
      ...
      uv_walk(&loop->uv, loop_walk_cb, ((void*)0));
      didstop = 1;
    }
...
{
  _Bool *timeout_expired = handle->data;
  *timeout_expired = 1;
}
