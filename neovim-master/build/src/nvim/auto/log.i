# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c"
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2
# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stdbool.h" 1 3
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2
...
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/build/config/auto/config.h" 1
# 19 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2
...
# 20 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2
...
# 21 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2
...
# 22 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2
...
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/execinfo.h" 1 3 4
# 28 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/execinfo.h" 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/os/base.h" 1 3 4
# 274 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/os/base.h" 3 4
typedef void (*os_function_t)(void *_Nullable);
# 317 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/os/base.h" 3 4
typedef void (^os_block_t)(void);
# 29 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/execinfo.h" 2 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/os/availability.h" 1 3 4
# 30 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/execinfo.h" 2 3 4
...
# 37 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c" 2


static _Bool log_try_create(char *fname)
{
  if (fname == ((void*)0) || fname[0] == '\0') {
    return 0;
  }
...
# 60 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c"
static _Bool log_path_init(void)
{
  ...
  if (strequal("$" "NVIM_LOG_FILE", log_file_path)
    ...
    char *failed_dir = ((void*)0);
    _Bool log_dir_failure = 0;
    if (!os_isdir((char_u *)cachehome)) {
      log_dir_failure = (os_mkdir_recurse(cachehome, 0700, &failed_dir) != 0);
    }
    do { void **ptr_ = (void **)&(cachehome); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
    ...
    os_setenv("NVIM_LOG_FILE", log_file_path, 1);
    if (log_dir_failure) {
      logmsg(3, ((void*)0), __func__, 96, 1, "Failed to create directory %s for writing logs: %s", failed_dir, uv_strerror(log_dir_failure));

    }
    do { void **ptr_ = (void **)&(failed_dir); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
  }
  return 1;
}
...
# 127 "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c"
_Bool logmsg(int log_level, const char *context, const char *func_name,
            int line_num, _Bool eol, const char *fmt, ...)
  FUNC_ATTR_UNUSED FUNC_ATTR_PRINTF(6, 7)
{
  ...
  if (log_file != __stderrp && log_file != __stdoutp) {
    fclose(log_file);
  }
end:
  log_unlock();
...
{
  static _Bool opening_log_file = 0;


  if (opening_log_file) {
    do_log_to_file(__stderrp, 4, ((void*)0), __func__, 191, 1,
                   "Cannot LOG() recursively.");
    return __stderrp;
  }

  FILE *log_file = ((void*)0);
  opening_log_file = 1;
  if (log_path_init()) {
  ...
  do_log_to_file(__stderrp, 4, ((void*)0), __func__, 211, 1,
                           ...
                           const int line_num)
{
  ...
  (__builtin_expect(!(24 + exepathlen < (1024+1)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c", 229, "24 + exepathlen < IOSIZE") : (void)0);

  char cmdbuf[(1024+1) + (20 * ((sizeof(trace)/sizeof((trace)[0])) / ((size_t)(!(sizeof(trace) % sizeof((trace)[0])))))) + 4096];
  __builtin___snprintf_chk (cmdbuf, sizeof(cmdbuf), 0, __builtin_object_size (cmdbuf, 1 > 1 ? 1 : 0), "addr2line -e %s -f -p", exepath);
  for (int i = 1; i < trace_size; i++) {
    char buf[20];
    __builtin___snprintf_chk (buf, sizeof(buf), 0, __builtin_object_size (buf, 1 > 1 ? 1 : 0), " %p", trace[i]);
    xstrlcat(cmdbuf, buf, sizeof(cmdbuf));
  }



  do_log_to_file(log_file, 1, ((void*)0), func_name, line_num, 1,
                 "trace:");
  FILE *fp = popen(cmdbuf, "r");
  char linebuf[(1024+1)];
  while (fgets(linebuf, sizeof(linebuf) - 1, fp) != ((void*)0)) {
...
static _Bool do_log_to_file(FILE *log_file, int log_level, const char *context,
                           const char *func_name, int line_num, _Bool eol,
                           const char *fmt, ...)
  FUNC_ATTR_PRINTF(7, 8)
{
  va_list args;
  __builtin_va_start(args, fmt);
  _Bool ret = v_do_log_to_file(log_file, log_level, context, func_name,
...
static _Bool v_do_log_to_file(FILE *log_file, int log_level,
                             ...
                             va_list args)
{
  ...
  (__builtin_expect(!(log_level >= 1 && log_level <= 4), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/log.c", 295, "log_level >= DEBUG_LOG_LEVEL && log_level <= ERROR_LOG_LEVEL") : (void)0);


  struct tm local_time;
  if (os_localtime(&local_time) == ((void*)0)) {
    return 0;
  }
  char date_time[20];
  ...
  int rv = (line_num == -1 || func_name == ((void*)0))
    ? fprintf(log_file, "%s %s.%03d %-5" "ll" "d" " %s",
              log_levels[log_level], date_time, millis, pid,
              (context == ((void*)0) ? "?:" : context))
    : fprintf(log_file, "%s %s.%03d %-5" "ll" "d" " %s%s:%d: ",
              log_levels[log_level], date_time, millis, pid,
              (context == ((void*)0) ? "" : context),
              func_name, line_num);
  if (rv < 0) {
