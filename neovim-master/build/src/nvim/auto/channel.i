# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/private/helpers.h" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/private/defs.h" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/ui.h" 1
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.h" 1
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2
...
# 20 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c" 2

static _Bool did_stdio = 0;
...
void channel_teardown(void)
{
  ...
  { khint_t __i; for (__i = (khint_t)(0); __i != ((channels->table)->n_buckets); ++__i) { if (!(!(((channels->table)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (channel) = ((channels->table)->vals[__i]); { channel_close(channel->id, kChannelPartAll, ((void*)0)); }; } };
...
Channel *channel_alloc(ChannelStreamType type)
{
  ...
  (__builtin_expect(!(chan->id <= 9223372036854775807LL), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c", 178, "chan->id <= VARNUMBER_MAX") : (void)0);
...
{
# 209 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c"
  (void)ext_source;


  channel_info_changed(chan, 1);
}
...
# 301 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c"
Channel *channel_job_start(char **argv, CallbackReader on_stdout,
                           CallbackReader on_stderr, Callback on_exit,
                           _Bool pty, _Bool rpc, _Bool overlapped, _Bool detach,
                           const char *cwd,
                           uint16_t pty_width, uint16_t pty_height,
                           dict_T *env, varnumber_T *status_out)
{
  (__builtin_expect(!(cwd == ((void*)0) || os_isdir_executable(cwd)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c", 308, "cwd == NULL || os_isdir_executable(cwd)") : (void)0);
  ...
  if (pty) {
    if (detach) {
      emsgf((const char *) (libintl_gettext((char *)(e_invarg2))), ("terminal/pty job cannot be detached"));
  ...
  int status = process_spawn(proc, 1, has_out, has_err);
  if (status) {
    emsgf((const char *) (libintl_gettext((char *)(e_jobspawn))), (uv_strerror(status)), (cmd));
    xfree(cmd);
    if (proc->env) {
...
uint64_t channel_connect(_Bool tcp, const char *address,
                         _Bool rpc, CallbackReader on_output,
                         int timeout, const char **error)
{
  ...
  if (!tcp && rpc) {
    ...
    _Bool loopback = server_owns_pipe_address(path);
    xfree(path);
    if (loopback) {
...
uint64_t channel_from_stdio(_Bool rpc, CallbackReader on_output,
                            const char **error)
  FUNC_ATTR_NONNULL_ALL
{
  if (!headless_mode && !embedded_mode) {
    *error = libintl_gettext((char *)("can only be opened in headless mode"));
    return 0;
  }

  if (did_stdio) {
    *error = libintl_gettext((char *)("channel was already open"));
    return 0;
  }
  did_stdio = 1;
  ...
  int stdin_dup_fd = 0;
  int stdout_dup_fd = 1;
# 487 "/Users/shi-rongliu/tool/neovim-master/src/nvim/channel.c"
...
size_t channel_send(uint64_t id, char *data, size_t len,
                    _Bool data_owned, const char **error)
{
  Channel *chan = find_channel(id);
  size_t written = 0;
  if (!chan) {
    *error = libintl_gettext((char *)(e_invchan));
    goto retfree;
  }

  if (chan->streamtype == kChannelStreamStderr) {
    if (chan->stream.err.closed) {
      *error = libintl_gettext((char *)("Can't send data to closed stream"));
      goto retfree;
    }

    written = len * fwrite(data, len, 1, __stderrp);
    goto retfree;
  }
  ...
  if (chan->is_rpc) {
    *error = libintl_gettext((char *)("Can't send raw data to rpc channel"));
    goto retfree;
  }
...
static void on_channel_output(Stream *stream, Channel *chan, RBuffer *buf,
                              size_t count, _Bool eof, CallbackReader *reader)
{
...
void channel_reader_callbacks(Channel *chan, CallbackReader *reader)
{
  if (reader->buffered) {
    if (reader->eof) {
      if (reader->self) {
        if (tv_dict_find(reader->self, reader->type, -1) == ((void*)0)) {
          ...
          emsgf((const char *) (libintl_gettext((char *)(e_streamkey))), (reader->type), (chan->id));
        }
      } else {
...
static void channel_process_exit_cb(Process *proc, int status, void *data)
{
  ...
  if (chan->term) {
    ...
    __builtin___snprintf_chk (msg, sizeof msg, 0, __builtin_object_size (msg, 1 > 1 ? 1 : 0), "\r\n[Process exited %d]", proc->status);
    terminal_close(chan->term, msg);
  }


  _Bool exited = (status >= 0);
...
static void set_info_event(void **argv)
{
  ...
  typval_T retval;
  (void)object_to_vim(((Object) { .type = kObjectTypeDictionary, .data.dictionary = info }), &retval, ((void*)0));
...
Dictionary channel_info(uint64_t id)
{
  ...
  switch (chan->streamtype) {
    ...
    case kChannelStreamInternal:
       (*((((info).size == (info).capacity) ? (((info).capacity = ((info).capacity ? (info).capacity << 1 : 8), (info).items = xrealloc((info).items, sizeof((info).items[0]) * (info).capacity)), 0) : 0), ((info).items + ((info).size++))) = (((KeyValuePair) { .key = cstr_to_string("internal"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
