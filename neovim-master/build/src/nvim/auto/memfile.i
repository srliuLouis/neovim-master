# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
# 41 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c"
...
# 42 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
...
# 43 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
...
# 44 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
...
# 45 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stdbool.h" 1 3
# 46 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
...
# 47 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
...
# 49 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
...
# 50 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.h" 1
# 51 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
...
# 52 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memline.h" 1
# 53 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
...
# 56 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/assert.h" 1
# 58 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/input.h" 1
# 60 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c" 2
# 81 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c"
memfile_T *mf_open(char_u *fname, int flags)
{
  ...
  mfp->mf_free_first = ((void*)0);
  mfp->mf_used_first = ((void*)0);
  mfp->mf_used_last = ((void*)0);
  mfp->mf_dirty = 0;
  ...
  if (mfp->mf_fd >= 0 && os_fileinfo_fd(mfp->mf_fd, &file_info)) {
    ...
    if (blocksize >= 1048 && blocksize <= 50000) {
      do { _Static_assert(50000 <= (2147483647 *2U +1U), "MAX_SWAP_PAGE_SIZE must fit into an unsigned"); } while (0);
  ...
  if (mfp->mf_fd < 0
      || (flags & (0x00000400|0x00000800))
      || (size = lseek(mfp->mf_fd, 0L, 2)) <= 0) {

    mfp->mf_blocknr_max = 0;
  } else {
    (__builtin_expect(!(sizeof(off_T) <= sizeof(blocknr_T) && mfp->mf_page_size > 0 && mfp->mf_page_size - 1 <= 9223372036854775807LL - size), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c", 128, "sizeof(off_T) <= sizeof(blocknr_T) && mfp->mf_page_size > 0 && mfp->mf_page_size - 1 <= INT64_MAX - size") : (void)0);
...
# 152 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c"
int mf_open_file(memfile_T *mfp, char_u *fname)
{
  if (mf_do_open(mfp, fname, 0x0002 | 0x00000200 | 0x00000800)) {
    mfp->mf_dirty = 1;
    return 1;
  }
...
void mf_close(memfile_T *mfp, _Bool del_file)
{
  ...
  if (mfp->mf_fd >= 0 && close(mfp->mf_fd) < 0) {
      emsg((char_u *)(libintl_gettext((char *)(e_swapclose))));
  }
  if (del_file && mfp->mf_fname != ((void*)0)) {
    os_remove((char *)mfp->mf_fname);
  }


  for (bhdr_T *hp = mfp->mf_used_first, *nextp; hp != ((void*)0); hp = nextp) {
    nextp = hp->bh_next;
    mf_free_bhdr(hp);
  }
  while (mfp->mf_free_first != ((void*)0)) {
...
bhdr_T *mf_new(memfile_T *mfp, _Bool negative, unsigned page_count)
{
  ...
  if (!negative && freep != ((void*)0) && freep->bh_page_count >= page_count) {
  ...
  (void)__builtin___memset_chk (hp->bh_data, 0, mfp->mf_page_size * page_count, __builtin_object_size (hp->bh_data, 0));
...
void mf_put(memfile_T *mfp, bhdr_T *hp, _Bool dirty, _Bool infile)
{
  ...
  if ((flags & 2U) == 0) {
    iemsg((const char *)(libintl_gettext((char *)("E293: block was not locked"))));
  }
  flags &= ~2U;
  if (dirty) {
    flags |= 1U;
...
# 366 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c"
int mf_sync(memfile_T *mfp, int flags)
{
  ...
  int status = 1;
  bhdr_T *hp;
  for (hp = mfp->mf_used_last; hp != ((void*)0); hp = hp->bh_prev)
...
{
  for (bhdr_T *hp = mfp->mf_used_last; hp != ((void*)0); hp = hp->bh_prev) {
    if (hp->bh_hashitem.mhi_key > 0) {
      hp->bh_flags |= 1U;
    }
  }
...
_Bool mf_release_all(void)
{
  ...
  for (buf_T *buf = firstbuf; buf != ((void*)0); buf = buf->b_next) {
    ...
    if (mfp != ((void*)0)) {
      ...
      if (mfp->mf_fd >= 0) {
        for (bhdr_T *hp = mfp->mf_used_last; hp != ((void*)0); ) {
          if (!(hp->bh_flags & 2U)
              && (!(hp->bh_flags & 1U)
                  || mf_write(mfp, hp) != 0)) {
            mf_rem_used(mfp, hp);
...
static int mf_read(memfile_T *mfp, bhdr_T *hp)
{
  ...
  if (lseek(mfp->mf_fd, offset, 0) != offset) {
    (void) emsgf("%s: %s", libintl_gettext((char *)("E294: Seek error in swap file read")), strerror((*__error())));
    return 0;
  }

  (__builtin_expect(!(hp->bh_page_count <= (2147483647 *2U +1U) / page_size), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c", 568, "hp->bh_page_count <= UINT_MAX / page_size") : (void)0);
  unsigned size = page_size * hp->bh_page_count;
  if ((unsigned)read_eintr(mfp->mf_fd, hp->bh_data, size) != size) {
    (void) emsgf("%s: %s", libintl_gettext((char *)("E295: Read error in swap file")), strerror((*__error())));
    return 0;
  }

  return 1;
}
# 586 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c"
static int mf_write(memfile_T *mfp, bhdr_T *hp)
{
  ...
  for (;;) {
    ...
    if (lseek(mfp->mf_fd, offset, 0) != offset) {
      (void) emsgf("%s: %s", libintl_gettext((char *)("E296: Seek error in swap file write")), strerror((*__error())));
      return 0;
    }
    if (hp2 == ((void*)0))
      page_count = 1;
    ...
    void *data = (hp2 == ((void*)0)) ? hp->bh_data : hp2->bh_data;
    if ((unsigned)write_eintr(mfp->mf_fd, data, size) != size) {
      ...
      if (!did_swapwrite_msg)
        emsg((char_u *)(libintl_gettext((char *)("E297: Write error in swap file"))));
      did_swapwrite_msg = 1;
      return 0;
    }
    did_swapwrite_msg = 0;
...
static int mf_trans_add(memfile_T *mfp, bhdr_T *hp)
{
  ...
  if (freep != ((void*)0) && freep->bh_page_count >= page_count) {
...
{
  do { void **ptr_ = (void **)&(mfp->mf_fname); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
  do { void **ptr_ = (void **)&(mfp->mf_ffname); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
}
...
{
  mfp->mf_fname = fname;
  mfp->mf_ffname = (char_u *)FullName_save((char *)mfp->mf_fname, 0);
}
...
{
  if (mfp != ((void*)0) && mfp->mf_fname != ((void*)0) && mfp->mf_ffname != ((void*)0)) {
    xfree(mfp->mf_fname);
...
{
  return mfp->mf_fname != ((void*)0) && mfp->mf_neg_count > 0;
}
...
static _Bool mf_do_open(memfile_T *mfp, char_u *fname, int flags)
{

  mf_set_fnames(mfp, fname);
  (__builtin_expect(!(mfp->mf_fname != ((void*)0)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c", 765, "mfp->mf_fname != NULL") : (void)0);
  ...
  if ((flags & 0x00000200)
    ...
    mfp->mf_fd = -1;
    emsg((char_u *)(libintl_gettext((char *)("E300: Swap file already exists (symlink attack?)"))));
  } else {

    mfp->mf_fd = os_open(((char *)mfp->mf_fname), (flags | 0x00000100), (mode_t)0600);
  }
...
# 801 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c"
static void mf_hash_init(mf_hashtab_T *mht)
{
  __builtin___memset_chk (mht, 0, sizeof(mf_hashtab_T), __builtin_object_size (mht, 0));
...
static void mf_hash_free_all(mf_hashtab_T *mht)
{
  for (size_t idx = 0; idx <= mht->mht_mask; idx++) {
    mf_hashitem_T *next;
    for (mf_hashitem_T *mhi = mht->mht_buckets[idx]; mhi != ((void*)0); mhi = next) {
      next = mhi->mhi_next;
      xfree(mhi);
    }
  }
...
static mf_hashitem_T *mf_hash_find(mf_hashtab_T *mht, blocknr_T key)
{
  ...
  while (mhi != ((void*)0) && mhi->mhi_key != key)
    mhi = mhi->mhi_next;
  return mhi;
}
...
# 900 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memfile.c"
    mf_hashitem_T *tails[2];
    __builtin___memset_chk (tails, 0, sizeof(tails), __builtin_object_size (tails, 0));

    for (mf_hashitem_T *mhi = mht->mht_buckets[i];
         mhi != ((void*)0); mhi = mhi->mhi_next) {
