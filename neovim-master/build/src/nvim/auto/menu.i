# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.h" 1
# 18 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 19 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 20 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 21 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 24 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 27 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 29 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
...
# 31 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/window.h" 1
# 32 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c" 2
# 44 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c"
...
static _Bool menu_is_winbar(const char_u *const name)
...
ex_menu(exarg_T *eap)
{
  ...
  if (strncmp((char *)(arg), (char *)("icon="), (size_t)(5)) == 0) {
    ...
    while (*arg != '\000' && *arg != ' ') {
      if (*arg == '\\')
        __builtin___memmove_chk ((arg), (arg + 1), strlen((char *)(arg + 1)) + 1, __builtin_object_size ((arg), 0));
  ...
  if (ascii_iswhite(*p)) {
    for (i = 0; i < 10 && !ascii_iswhite(*arg); i++) {
      pri_tab[i] = getdigits_long(&arg, 0, 0);
      if (pri_tab[i] == 0) {
        pri_tab[i] = 500;
      }
      if (*arg == '.') {
  ...
  menu_path = arg;
  if (*menu_path == '.') {
    emsgf((const char *) (libintl_gettext((char *)(e_invarg2))), (menu_path));
    goto theend;
  }
  ...
  if (enable != kNone) {
    ...
    if (menu_is_popup(menu_path)) {
      for (i = 0; i < MENU_INDEX_TIP; ++i)
        if (modes & (1 << i)) {
          p = popup_mode_name(menu_path, i);
          remove_menu(root_menu_ptr, p, ((1 << MENU_INDEX_TIP) - 1), 1);
          xfree(p);
        }
    }


    remove_menu(root_menu_ptr, menu_path, modes, 0);
  } else {
    ...
    if (strcasecmp((char *)(map_to), (char *)("<nop>")) == 0) {
      ...
      map_to = replace_termcodes(map_to, strlen((char *)(map_to)), &map_buf, 0, 1,
                                 1, ((vim_strchr(p_cpo, 'B') == ((void*)0)) ? 0 : 0x01));
    }
    menuarg.modes = modes;
...
)
{
  ...
  while (*name) {
    ...
    dname = menu_text(name, ((void*)0), ((void*)0));
    if (*dname == '\000') {

      emsg((char_u *)(libintl_gettext((char *)("E792: Empty menu name"))));
      goto erret;
    }
    ...
    while (menu != ((void*)0)) {
      if (menu_name_equal(name, menu) || menu_name_equal(dname, menu)) {
        if (*next_name == '\000' && menu->children != ((void*)0)) {
          if (!sys_menu) {
            emsg((char_u *)(libintl_gettext((char *)("E330: Menu path must not lead to a sub-menu"))));
          }
          goto erret;
        }
        if (*next_name != '\000' && menu->children == ((void*)0)) {
          if (!sys_menu) {
            emsg((char_u *)(libintl_gettext((char *)(e_notsubmenu))));
          }
          goto erret;
        }
        break;
      ...
      if (parent != ((void*)0) || menu_is_menubar(menu->name)) {
    ...
    if (menu == ((void*)0)) {
      if (*next_name == '\000' && parent == ((void*)0)) {
        emsg((char_u *)(libintl_gettext((char *)("E331: Must not add menu items directly to menu bar"))));
        goto erret;
      }

      if (menu_is_separator(dname) && *next_name != '\000') {
        emsg((char_u *)(libintl_gettext((char *)("E332: Separator cannot be part of a menu path"))));
        goto erret;
      }
      ...
      if (en_name != ((void*)0)) {
        ...
        menu->en_dname = menu_text(en_name, ((void*)0), ((void*)0));
      } else {
        menu->en_name = ((void*)0);
        menu->en_dname = ((void*)0);
      }
    ...
    parent = menu;
    name = next_name;
    do { void **ptr_ = (void **)&(dname); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
  ...
  if (menu != ((void*)0) && modes) {
    p = (call_data == ((void*)0)) ? ((void*)0) : vim_strsave(call_data);
    ...
    for (i = 0; i < MENU_MODES; ++i) {
      if (modes & (1 << i)) {
        ...
        c = 0;
        d = 0;
        if (amenu && call_data != ((void*)0) && *call_data != '\000') {
          switch (1 << i) {
        ...
        if (c != 0) {
          ...
          menu->strings[i][0] = c;
          if (d == 0) {
            __builtin___strcpy_chk ((char *)(menu->strings[i] + 1), (char *)(call_data), __builtin_object_size ((char *)(menu->strings[i] + 1), 1 > 1 ? 1 : 0));
          } else {
            menu->strings[i][1] = d;
            __builtin___strcpy_chk ((char *)(menu->strings[i] + 2), (char *)(call_data), __builtin_object_size ((char *)(menu->strings[i] + 2), 1 > 1 ? 1 : 0));
          }
          if (c == 3) {
...
erret:
  ...
  while (parent != ((void*)0) && parent->children == ((void*)0)) {
    if (parent->parent == ((void*)0)) {
      menup = root_menu_ptr;
    } else {
      menup = &parent->parent->children;
    }
    for (; *menup != ((void*)0) && *menup != parent; menup = &((*menup)->next)) {
    }
    if (*menup == ((void*)0)) {
      break;
    }
                               ...
                               int enable)
{
  ...
  if (*name != '\000' && *name != '*' && menu == ((void*)0)) {
    emsgf((const char *) (libintl_gettext((char *)(e_nomenu))), (name));
    return 0;
  }
...
)
{
  ...
  while ((menu = *menup) != ((void*)0)) {
    if (*name == '\000' || menu_name_equal(name, menu)) {
      if (*p != '\000' && menu->children == ((void*)0)) {
        if (!silent)
          emsg((char_u *)(libintl_gettext((char *)(e_notsubmenu))));
        return 0;
      }
      if ((menu->modes & modes) != 0x0) {
        ...
        if (!silent)
          emsg((char_u *)(libintl_gettext((char *)(e_othermode))));
        return 0;
      }
...
static void free_menu_string(vimmenu_T *menu, int idx)
{
  ...
  menu->strings[idx] = ((void*)0);
}
# 689 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c"
static dict_T *menu_get_recursive(const vimmenu_T *menu, int modes)
{
  ...
  if (!menu->children) {
    ...
    for (menu = menu->children; menu != ((void*)0); menu = menu->next) {
...
# 759 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c"
...
static void show_menus_recursive(vimmenu_T *menu, int modes, int depth)
{
  ...
  if (menu != ((void*)0) && (menu->modes & modes) == 0x0)
    return;
  ...
  if (menu != ((void*)0) && menu->children == ((void*)0)) {
    for (bit = 0; bit < MENU_MODES; bit++)
      if ((menu->modes & modes & (1 << bit)) != 0) {
        ...
        if (*menu->strings[bit] == '\000') {
          ...
          msg_outtrans_special(menu->strings[bit], 0, 0);
        }
      }
  } else {
    if (menu == ((void*)0)) {
    ...
    for (; menu != ((void*)0) && !got_int; menu = menu->next)
...
static vimmenu_T *expand_menu = ((void*)0);
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (*p == '\000') {
    ...
    expand_modes = get_menu_cmd_modes(cmd, forceit, ((void*)0), &unmenu);
    if (!unmenu)
...
char_u *get_menu_name(expand_T *xp, int idx)
{
  ...
  while (menu != ((void*)0) && (menu_is_hidden(menu->dname)
                          || menu_is_separator(menu->dname)
                          || menu->children == ((void*)0))) {
    menu = menu->next;
  }
...
char_u *get_menu_names(expand_T *xp, int idx)
{
  ...
  if (menu->modes & expand_modes) {
    if (menu->children != ((void*)0)) {
      ...
      __builtin___strcat_chk ((char *)(tbuffer), (char *)("\001"), __builtin_object_size ((char *)(tbuffer), 1 > 1 ? 1 : 0));
      str = tbuffer;
    } else {
      if (should_advance)
        str = menu->en_dname;
...
# 1181 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c"
int
get_menu_cmd_modes(
    const char *cmd,
    _Bool forceit,
...
static char_u *popup_mode_name(char_u *name, int idx)
{
  ...
  (__builtin_expect(!(len >= 4), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c", 1250, "len >= 4") : (void)0);

  char_u *p = vim_strnsave(name, len + 1);
  __builtin___memmove_chk (p + 6, p + 5, len - 4, __builtin_object_size (p + 6, 0));
  p[5] = menu_mode_chars[idx];

  return p;
}
# 1271 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c"
  ...
  FUNC_ATTR_NONNULL_ARG(1)
{
  ...
  if (p != ((void*)0)) {
    ...
    (__builtin_expect(!(p >= str), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c", 1283, "p >= str") : (void)0);
...
_Bool menu_is_menubar(const char_u *const name)
  FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ALL
{
...
_Bool menu_is_popup(const char_u *const name)
  FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ALL
{
...
_Bool menu_is_toolbar(const char_u *const name)
  FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ALL
{
  ...
  FUNC_ATTR_NONNULL_ARG(2)
{
  ...
  } else if (eap != ((void*)0) && eap->addr_count) {
    pos_T tpos;
  ...
  (__builtin_expect(!(idx != MENU_INDEX_INVALID), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c", 1416, "idx != MENU_INDEX_INVALID") : (void)0);
  if (menu->strings[idx] != ((void*)0)) {



    if (eap == ((void*)0) || current_sctx.sc_sid != 0) {
      ...
      ins_typebuf(menu->strings[idx], menu->noremap[idx], 0, 1,
                  menu->silent[idx]);
    }
  } else if (eap != ((void*)0)) {
    emsgf((const char *) (libintl_gettext((char *)("E335: Menu not defined for %s mode"))), (mode));
  }
}
...
void ex_emenu(exarg_T *eap)
{
  ...
  while (*name) {
    ...
    while (menu != ((void*)0)) {
      if (menu_name_equal(name, menu)) {
        if (*p == '\000' && menu->children != ((void*)0)) {
          emsg((char_u *)(libintl_gettext((char *)("E333: Menu path must lead to a menu item"))));
          menu = ((void*)0);
        } else if (*p != '\000' && menu->children == ((void*)0)) {
          emsg((char_u *)(libintl_gettext((char *)(e_notsubmenu))));
          menu = ((void*)0);
        }
        break;
  ...
  xfree(saved_name);
  if (menu == ((void*)0)) {
    emsgf((const char *) (libintl_gettext((char *)("E334: Menu not found: %s"))), (eap->arg));
    return;
  }
...
static garray_T menutrans_ga = { 0, 0, 0, 1, ((void*)0) };
# 1503 "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c"
void ex_menutranslate(exarg_T *eap)
{
  ...
  if (strncmp((char *)(arg), (char *)("clear"), (size_t)(5)) == 0 && ends_excmd(*skipwhite(arg + 5))) {
    do { garray_T *_gap = (&menutrans_ga); if (_gap->ga_data != ((void*)0)) { for (int i = 0; i < _gap->ga_len; i++) { menutrans_T *_item = &(((menutrans_T *)_gap->ga_data)[i]); menutrans_T* _mt = (_item); xfree(_mt->from); xfree(_mt->from_noamp); xfree(_mt->to); } } ga_clear(_gap); } while (0);
    ...
    *arg = '\000';
    ...
    if (arg == to)
      ...
      from_noamp = menu_text(from, ((void*)0), ((void*)0));
      (__builtin_expect(!(arg >= to), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/menu.c", 1531, "arg >= to") : (void)0);
...
static char_u *menu_translate_tab_and_shift(char_u *arg_start)
{
  ...
  while (*arg && !ascii_iswhite(*arg)) {
    if ((*arg == '\\' || *arg == 22) && arg[1] != '\000')
      ...
      *arg = '\011';
      __builtin___memmove_chk ((arg + 1), (arg + 5), strlen((char *)(arg + 5)) + 1, __builtin_object_size ((arg + 1), 0));
    }
    arg++;
  }
  if (*arg != '\000')
