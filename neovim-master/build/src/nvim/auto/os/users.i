# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/users.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/users.c" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/users.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/build/config/auto/config.h" 1
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/users.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/users.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/users.c" 2
# 24 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/users.c"
static void add_user(garray_T *users, char *user, _Bool need_copy)
{
  char *user_copy = (user != ((void*)0) && need_copy)
    ? xstrdup(user) : user;

  if (user_copy == ((void*)0) || *user_copy == '\000') {
    if (need_copy) {
      xfree(user);
    }
    return;
...
int os_get_usernames(garray_T *users)
{
...

  {
    ...
    while ((pw = getpwent()) != ((void*)0)) {
      add_user(users, pw->pw_name, 1);
    }
    endpwent();
  }
# 79 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/users.c"
  {
    ...
    if (user_env != ((void*)0) && *user_env != '\000') {
      int i;
...
int os_get_uname(uv_uid_t uid, char *s, size_t len)
{
  ...
  if ((pw = getpwuid(uid)) != ((void*)0)
      && pw->pw_name != ((void*)0) && *(pw->pw_name) != '\000') {
    xstrlcpy((char *)(s), (char *)(pw->pw_name), (size_t)(len));
    return 1;
  }

  __builtin___snprintf_chk (s, len, 0, __builtin_object_size (s, 1 > 1 ? 1 : 0), "%d", (int)uid);
  return 0;
}
