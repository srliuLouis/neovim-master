# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.h" 2


typedef uint64_t Timestamp;
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/input.h" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c" 2
...
# 51 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c"
...
void os_delay(uint64_t ms, _Bool ignoreinput)
{
  ...
  if (ignoreinput) {
    ...
    do { int remaining = (int)ms; uint64_t before = (remaining > 0) ? os_hrtime() : 0; while (!(got_int)) { do { if (((void*)0) && !multiqueue_empty(((void*)0))) { multiqueue_process_events(((void*)0)); } else { loop_poll_events(&main_loop, remaining); } } while (0); if (remaining == 0) { break; } else if (remaining > 0) { uint64_t now = os_hrtime(); remaining -= (int) ((now - before) / 1000000); before = now; if (remaining <= 0) { break; } } } } while (0);
  } else {
    os_microdelay(ms * 1000u, ignoreinput);
  }
}
# 83 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c"
void os_microdelay(uint64_t us, _Bool ignoreinput)
{
  uint64_t elapsed = 0u;
  uint64_t base = uv_hrtime();

  const uint64_t ns = (us < 18446744073709551615ULL / 1000u) ? us * 1000u : 18446744073709551615ULL;
  ...
  while (elapsed < ns) {
    ...
    const uint64_t ns_delta = ignoreinput
                              ? ns - elapsed
                              : (((ns - elapsed)<(100000000u))?(ns - elapsed):(100000000u));
...
# 153 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/time.c"
}
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_NONNULL_RET
{
  ...
  if (clock_local_ptr == ((void*)0)) {
    xstrlcpy(result, libintl_gettext((char *)("(Invalid)")), result_len);
  } else {
    strftime(result, result_len, libintl_gettext((char *)("%a %b %d %H:%M:%S %Y")), clock_local_ptr);
  }
  xstrlcat(result, "\n", result_len);
  return result;
}
