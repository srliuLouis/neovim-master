# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2




# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stdbool.h" 1 3
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
pid_t tcgetsid(int);
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2





# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/util.h" 1 3 4
# 64 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/util.h" 3 4
...
# 65 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/util.h" 2 3 4
...
# 66 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/util.h" 2 3 4
# 88 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/util.h" 3 4
struct utmp;
void login(struct utmp *) __attribute__((availability(macosx,introduced=10.0,deprecated=10.5)));
int login_tty(int);
int logout(const char *) __attribute__((availability(macosx,introduced=10.0,deprecated=10.5)));
void logwtmp(const char *, const char *, const char *) __attribute__((availability(macosx,introduced=10.0,deprecated=10.5)));
...
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/utmp.h" 1 3 4
# 86 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/utmp.h" 3 4
struct lastlog {
 time_t ll_time;
 char ll_line[8];
 char ll_host[16];
...
# 108 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/util.h" 2 3 4
# 19 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 25 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 28 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 30 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 32 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 33 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 34 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 35 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 36 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
...
# 38 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c" 2
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  (__builtin_expect(!(proc->err.closed), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c", 68, "proc->err.closed") : (void)0);
  uv_signal_start(&proc->loop->children_watcher, chld_handler, 20);
  ptyproc->winsize = (struct winsize){ ptyproc->height, ptyproc->width, 0, 0 };
  uv_disable_stdio_inheritance();
  int master;
  int pid = forkpty(&master, ((void*)0), &termios_default, &ptyproc->winsize);

  if (pid < 0) {
    status = -(*__error());
    logmsg(4, ((void*)0), __func__, 77, 1, "forkpty failed: %s", strerror((*__error())));
    return status;
  } else if (pid == 0) {
    init_child(ptyproc);
  }
  ...
  int master_status_flags = fcntl(master, 3);
  if (master_status_flags == -1) {
    status = -(*__error());
    logmsg(4, ((void*)0), __func__, 87, 1, "Failed to get master descriptor status flags: %s", strerror((*__error())));
    goto error;
  }
  if (fcntl(master, 4, master_status_flags | 0x00000004) == -1) {
    status = -(*__error());
    logmsg(4, ((void*)0), __func__, 92, 1, "Failed to make master descriptor non-blocking: %s", strerror((*__error())));
    goto error;
  }
  ...
  if (os_set_cloexec(master) == -1) {
    status = -(*__error());
    logmsg(4, ((void*)0), __func__, 99, 1, "Failed to set CLOEXEC on ptmx file descriptor");
    goto error;
  }
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  ioctl(ptyproc->tty_fd, ((__uint32_t)0x80000000 | ((sizeof(struct winsize) & 0x1fff) << 16) | ((('t')) << 8) | ((103))), &ptyproc->winsize);
}
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (proc->cwd && os_chdir(proc->cwd) != 0) {
    logmsg(4, ((void*)0), __func__, 178, 1, "chdir(%s) failed: %s", proc->cwd, strerror((*__error())));
    return;
  }

  char *prog = ptyproc->process.argv[0];

  (__builtin_expect(!(proc->env), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/pty_process_unix.c", 184, "proc->env") : (void)0);
  (*_NSGetEnviron()) = tv_dict_to_env(proc->env);
  execvp(prog, proc->argv);
  logmsg(4, ((void*)0), __func__, 187, 1, "execvp(%s) failed: %s", prog, strerror((*__error())));
...
static void init_termios(struct termios *termios) FUNC_ATTR_NONNULL_ALL
{
  ...
  termios->c_iflag = 0x00000100|0x00000200;
  termios->c_oflag = 0x00000001|0x00000002;

  termios->c_oflag |= 0x00000000;

  termios->c_cflag = 0x00000300|0x00000800;
  termios->c_lflag = 0x00000080|0x00000100|0x00000400|0x00000008|0x00000002|0x00000004;

  cfsetspeed(termios, 38400);


  termios->c_iflag |= 0x00004000;
  ...
  termios->c_lflag |= 0x00000040;


  termios->c_lflag |= 0x00000001;


  termios->c_cc[8] = 0x1f & 'C';
  termios->c_cc[9] = 0x1f & '\\';
  termios->c_cc[3] = 0x7f;
  termios->c_cc[5] = 0x1f & 'U';
  termios->c_cc[0] = 0x1f & 'D';
  termios->c_cc[1] = ((unsigned char)'\377');
  termios->c_cc[2] = ((unsigned char)'\377');
  termios->c_cc[12] = 0x1f & 'Q';
  termios->c_cc[13] = 0x1f & 'S';
  termios->c_cc[10] = 0x1f & 'Z';
  termios->c_cc[6] = 0x1f & 'R';
  termios->c_cc[4] = 0x1f & 'W';
  termios->c_cc[14] = 0x1f & 'V';
  termios->c_cc[16] = 1;
  termios->c_cc[17] = 0;
}
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (fd_dup < 0) {
    status = -(*__error());
    logmsg(4, ((void*)0), __func__, 254, 1, "Failed to dup descriptor %d: %s", fd, strerror((*__error())));
    return status;
  }

  if (os_set_cloexec(fd_dup) == -1) {
    status = -(*__error());
    logmsg(4, ((void*)0), __func__, 260, 1, "Failed to set CLOEXEC on duplicate fd");
    goto error;
  }

  status = uv_pipe_open(pipe, fd_dup);
  if (status) {
    logmsg(4, ((void*)0), __func__, 267, 1, "Failed to set pipe to descriptor %d: %s", fd_dup, uv_strerror(status));
...
static void chld_handler(uv_signal_t *handle, int signum)
{
  ...
  for (kl1_WatcherPtr **current = ((void*)0) ? ((void*)0) : &loop->children->head; *current != loop->children->tail; current = &(*current)->next) {
    Process *proc = (*current)->data;
    do {
      pid = waitpid(proc->pid, &stat, 0x00000001);
    } while (pid < 0 && (*__error()) == 4);
    ...
    if ((((*(int *)&(stat)) & 0177) == 0)) {
      proc->status = (((*(int *)&(stat)) >> 8) & 0x000000ff);
    } else if ((((*(int *)&(stat)) & 0177) != 0177 && ((*(int *)&(stat)) & 0177) != 0)) {
      proc->status = 128 + (((*(int *)&(stat)) & 0177));
    }
