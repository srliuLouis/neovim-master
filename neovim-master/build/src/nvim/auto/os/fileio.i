# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2
# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stdbool.h" 1 3
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/build/config/auto/config.h" 1
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2
...
# 19 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2
...
# 22 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2
...
# 24 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2
...
# 25 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2
...
# 26 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c" 2
# 47 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT
{
  int os_open_flags = 0;
  TriState wr = kNone;
# 64 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
  do { if (flags & kFileWriteOnly) { os_open_flags |= 0x0001; (__builtin_expect(!(1), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 64, "1") : (void)0); if (kTrue != kNone) { wr = kTrue; } } } while (0);
  do { if (flags & kFileCreateOnly) { os_open_flags |= 0x00000200|0x00000800|0x0001; (__builtin_expect(!(1), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 65, "1") : (void)0); if (kTrue != kNone) { wr = kTrue; } } } while (0);
  do { if (flags & kFileCreate) { os_open_flags |= 0x00000200|0x0001; (__builtin_expect(!(!(flags & kFileCreateOnly)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 66, "!(flags & kFileCreateOnly)") : (void)0); if (kTrue != kNone) { wr = kTrue; } } } while (0);
  do { if (flags & kFileTruncate) { os_open_flags |= 0x00000400|0x0001; (__builtin_expect(!(!(flags & kFileCreateOnly)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 68, "!(flags & kFileCreateOnly)") : (void)0); if (kTrue != kNone) { wr = kTrue; } } } while (0);

  do { if (flags & kFileAppend) { os_open_flags |= 0x00000008|0x0001; (__builtin_expect(!(!(flags & kFileCreateOnly)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 70, "!(flags & kFileCreateOnly)") : (void)0); if (kTrue != kNone) { wr = kTrue; } } } while (0);

  do { if (flags & kFileReadOnly) { os_open_flags |= 0x0000; (__builtin_expect(!(wr != kTrue), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 71, "wr != kTrue") : (void)0); if (kFalse != kNone) { wr = kFalse; } } } while (0);

  do { if (flags & kFileNoSymlink) { os_open_flags |= 0x00000100; (__builtin_expect(!(1), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 73, "1") : (void)0); if (kNone != kNone) { wr = kNone; } } } while (0);
...
# 102 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT
{
  ...
  (__builtin_expect(!(!ret_fp->wr || !ret_fp->non_blocking), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 113, "!ret_fp->wr || !ret_fp->non_blocking") : (void)0);
  ret_fp->fd = fd;
  ret_fp->eof = 0;
...
# 134 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
...
# 155 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
...
int file_close(FileDescriptor *const fp, const _Bool do_fsync)
  FUNC_ATTR_NONNULL_ALL
{
...
int file_free(FileDescriptor *const fp, const _Bool do_fsync)
  FUNC_ATTR_NONNULL_ALL
{
...
static void file_rb_write_full_cb(RBuffer *const rv, FileDescriptor *const fp)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(fp->wr), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 255, "fp->wr") : (void)0);
  (__builtin_expect(!(rv->data == (void *)fp), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 256, "rv->data == (void *)fp") : (void)0);
...
# 280 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
ptrdiff_t file_read(FileDescriptor *const fp, char *const ret_buf,
                    const size_t size)
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT
{
  (__builtin_expect(!(!fp->wr), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 284, "!fp->wr") : (void)0);
  char *buf = ret_buf;
  ...
  while (read_remaining) {
    ...
    if (rv_size > 0) {
      const size_t rsize = rbuffer_read(rv, buf, (((rv_size)<(read_remaining))?(rv_size):(read_remaining)));
      buf += rsize;
    ...
    if (read_remaining) {
      (__builtin_expect(!(rbuffer_size(rv) == 0), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 302, "rbuffer_size(rv) == 0") : (void)0);
      rbuffer_reset(rv);
      ...
      (__builtin_expect(!(write_count == kRWBufferSize), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 313, "write_count == kRWBufferSize") : (void)0);
...
# 352 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
      called_read = 1;
    }
  }
  return (ptrdiff_t)(size - read_remaining);
}
# 365 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
ptrdiff_t file_write(FileDescriptor *const fp, const char *const buf,
                     const size_t size)
  FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ARG(1)
{
  (__builtin_expect(!(fp->wr), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 369, "fp->wr") : (void)0);
...
ptrdiff_t file_skip(FileDescriptor *const fp, const size_t size)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(!fp->wr), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 392, "!fp->wr") : (void)0);
  size_t read_bytes = 0;
  do {
    const ptrdiff_t new_read_bytes = file_read(
        fp, skipbuf, (((size - read_bytes)<(sizeof(skipbuf)))?(size - read_bytes):(sizeof(skipbuf))));
    if (new_read_bytes < 0) {
...
# 415 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c"
int msgpack_file_write(void *data, const char *buf, size_t len)
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT
{
  (__builtin_expect(!(len < (9223372036854775807L)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/fileio.c", 418, "len < PTRDIFF_MAX") : (void)0);
...
{
  emsgf(libintl_gettext((char *)("E5420: Failed to write to file: %s")), uv_strerror(error));
  return -1;
}
