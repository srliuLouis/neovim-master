# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stdbool.h" 1 3
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/fileio.h" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.h" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.h" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/libuv_process.h" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 19 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 20 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/signal.h" 1
# 22 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 25 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 29 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 30 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memline.h" 1
# 31 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
# 33 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c" 2
...
{
  for (int i = 0; i < num; i++) {
    if (vim_strchr(file[i], '$') != ((void*)0)) {
      return 1;
    }
  }
  return 0;
}
# 102 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c"
  ...
  FUNC_ATTR_NONNULL_ARG(4)
{
  ...
  *file = ((void*)0);
  ...
  if ((tempname = vim_tempname()) == ((void*)0)) {
    emsg((char_u *)(libintl_gettext((char *)(e_notmp))));
    return 0;
  }
# 181 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c"
  if (num_pat == 1 && *pat[0] == '`'
  ...
  if (shell_style == 0
      && strstr((char *)path_tail(p_sh), "sh") != ((void*)0)) {
    shell_style = 2;
  }
  ...
  for (i = 0; i < num_pat; i++) {
    ...
    for (j = 0; pat[i][j] != '\000'; j++) {
      if (vim_strchr((char_u *)"\t \"&'$;<>()\\|", pat[i][j]) != ((void*)0)) {
        len++;
      }
      len++;
    }
  ...
  if (shell_style == 4) {
    ...
    if (is_fish_shell) {
      __builtin___strcpy_chk ((char *)(command), (char *)("begin; "), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
    } else {
      __builtin___strcpy_chk ((char *)(command), (char *)("("), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
    }
    __builtin___strcat_chk ((char *)(command), (char *)(pat[0] + 1), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
    p = command + strlen((char *)(command)) - 1;
    if (is_fish_shell) {
      *p-- = ';';
      __builtin___strcat_chk ((char *)(command), (char *)(" end"), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
    } else {
      *p-- = ')';
    }
    ...
    __builtin___strcat_chk ((char *)(command), (char *)(">"), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
  } else {
    if (flags & 0x04) {
      __builtin___strcpy_chk ((char *)(command), (char *)("set nonomatch; "), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
    } else {
      __builtin___strcpy_chk ((char *)(command), (char *)("unset nonomatch; "), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
    }
    if (shell_style == 1) {
      __builtin___strcat_chk ((char *)(command), (char *)("glob >"), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
    } else if (shell_style == 3) {
      __builtin___strcat_chk ((char *)(command), (char *)("print -N >"), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
    } else if (shell_style == 2) {
      __builtin___strcat_chk ((char *)(command), (char *)(sh_vimglob_func), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
    } else {
      __builtin___strcat_chk ((char *)(command), (char *)("echo >"), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
    }
  }

  __builtin___strcat_chk ((char *)(command), (char *)(tempname), __builtin_object_size ((char *)(command), 1 > 1 ? 1 : 0));
      ...
      *p++ = ' ';
      for (j = 0; pat[i][j] != '\000'; j++) {
        if (pat[i][j] == '`') {
          ...
          if (intick
              || vim_strchr((char_u *)"\t \"&'$;<>()\\|", pat[i][j + 1]) != ((void*)0)
              || pat[i][j + 1] == '`') {
            *p++ = '\\';
          }
          j++;
                   ...
                   && vim_strchr((char_u *)"\t \"&'$;<>()\\|", pat[i][j]) != ((void*)0)) {
  ...
  if (i) {
    ...
    if (!(flags & 0x20)) {
      msg_putchar('\n');
      cmdline_row = Rows - 1;
      msg((char_u *)(libintl_gettext((char *)(e_wildexpand))));
      msg_start();
    }
  ...
  (__builtin_expect(!(buffer[len] == '\000' || buffer[len] == '\n'), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c", 461, "buffer[len] == NUL || buffer[len] == '\\n'") : (void)0);
  ...
  *file = xmalloc(sizeof(char_u *) * (size_t)i);
  ...
  for (j = 0, i = 0; i < *num_file; i++) {
    ...
    if (!dir && (flags & 0x40)
        && !os_can_exe((char *)(*file)[i], ((void*)0), !(flags & 0x2000))) {
      continue;
    }

    p = xmalloc(strlen((char *)((*file)[i])) + 1 + dir);
    __builtin___strcpy_chk ((char *)(p), (char *)((*file)[i]), __builtin_object_size ((char *)(p), 1 > 1 ? 1 : 0));
    if (dir) {
      add_pathsep((char *)p);
    }
    (*file)[j++] = p;
  ...
  *num_file = j;
  ...
  if (*num_file == 0) {
    do { void **ptr_ = (void **)&(*file); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
    goto notfound;
  }
...
# 550 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c"
char **shell_build_argv(const char *cmd, const char *extra_args)
  FUNC_ATTR_NONNULL_RET
{
  size_t argc = tokenize(p_sh, ((void*)0)) + (cmd ? tokenize(p_shcf, ((void*)0)) : 0);
  ...
  (__builtin_expect(!(rv[0]), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c", 570, "rv[0]") : (void)0);
...
# 636 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c"
int os_call_shell(char_u *cmd, ShellOpts opts, char_u *extra_args)
{
  DynamicBuffer input = { ((void*)0), 0, 0 };
  char *output = ((void*)0), **output_ptr = ((void*)0);
  int current_state = State;
  _Bool forward_output = 1;
  ...
  if (output) {
    (void)write_output(output, nread, 1);
    xfree(output);
  }
...
# 708 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c"
...
{
  return do_os_system(argv, input, len, output, nread, 1, 0);
}
...
static int do_os_system(char **argv,
                        ...
                        size_t *nread,
                        _Bool silent,
                        _Bool forward_output)
{
  out_data_decide_throttle(0);
  out_data_ring(((void*)0), 0);
  _Bool has_input = (input != ((void*)0) && input[0] != '\0');


  DynamicBuffer buf = { ((void*)0), 0, 0 };
  ...
  proc->events = events;
  proc->argv = argv;
  int status = process_spawn(proc, has_input, 1, 1);
  if (status) {
  ...
  if (has_input) {
    WBuffer *input_buffer = wstream_new_buffer((char *)input, len, 1, ((void*)0));
    ...
    wstream_set_write_cb(&proc->in, shell_write_cb, ((void*)0));
  }
  ...
  int exitcode = process_wait(proc, -1, ((void*)0));
  if (!got_int && out_data_decide_throttle(0)) {

    out_data_ring(((void*)0), 18446744073709551615UL);
  }
  if (forward_output) {
  ...
  (__builtin_expect(!(multiqueue_empty(events)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c", 833, "multiqueue_empty(events)") : (void)0);
  multiqueue_free(events);
...
{
  if (buf->cap >= desired) {
    (__builtin_expect(!(buf->data), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c", 845, "buf->data") : (void)0);
    return;
  }
...
# 886 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c"
static _Bool out_data_decide_throttle(size_t size)
{
  ...
  if (!size) {
    _Bool previous_decision = (visit > 0);
...
# 945 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c"
static void out_data_ring(char *output, size_t size)
{
  ...
  (__builtin_expect(!(output != ((void*)0) || (size == 0 || size == 18446744073709551615UL)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c", 951, "output != NULL || (size == 0 || size == SIZE_MAX)") : (void)0);

  if (output == ((void*)0) && size == 0) {
    last_skipped_len = 0;
    return;
  }

  if (output == ((void*)0) && size == 18446744073709551615UL) {
    out_data_append_to_screen(last_skipped, &last_skipped_len, 1);
    return;
  }
  ...
  if (size >= (1024 * 10U / 2)) {
    ...
    __builtin___memcpy_chk (last_skipped, output + start, (1024 * 10U / 2), __builtin_object_size (last_skipped, 0));
    last_skipped_len = (1024 * 10U / 2);
  } else if (size > 0) {

    size_t keep_len = (((last_skipped_len)<((1024 * 10U / 2) - size))?(last_skipped_len):((1024 * 10U / 2) - size));
    size_t keep_start = last_skipped_len - keep_len;

    if (keep_start) {
      __builtin___memmove_chk (last_skipped, last_skipped + keep_start, keep_len, __builtin_object_size (last_skipped, 0));
    }

    __builtin___memcpy_chk (last_skipped + keep_len, output, size, __builtin_object_size (last_skipped + keep_len, 0));
...
static void out_data_append_to_screen(char *output, size_t *count, _Bool eof)
  FUNC_ATTR_NONNULL_ALL
{
...
# 1048 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/shell.c"
...
static void read_input(DynamicBuffer *buf)
{
  ...
  for (;;) {
    ...
    if (l == 0) {
      ...
      len = s == ((void*)0) ? l : (size_t)(s - (lp + written));
      dynamic_buffer_ensure(buf, buf->len + len);
      __builtin___memcpy_chk (buf->data + buf->len, lp + written, len, __builtin_object_size (buf->data + buf->len, 0));
      buf->len += len;
    }
...
static size_t write_output(char *output, size_t remaining, _Bool eof)
{
  ...
  if (eof) {
    if (remaining) {
      ...
      ml_append(curwin->w_cursor.lnum++, (char_u *)output, 0, 0);
...
static void shell_write_cb(Stream *stream, void *data, int status)
{
  if (status) {
    ...
    msg_schedule_emsgf(libintl_gettext((char *)("E5677: Error writing input to shell-command: %s")),
                       uv_err_name(status));
  }
  stream_close(stream, ((void*)0), ((void*)0));
}
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_MALLOC FUNC_ATTR_WARN_UNUSED_RESULT
{
  ...
  if (*p_sxe != '\000' && strcmp((char *)(p_sxq), (char *)("(")) == 0) {
    ecmd = (char *)vim_strsave_escaped_ext((char_u *)cmd, p_sxe, '^', 0);
  }
