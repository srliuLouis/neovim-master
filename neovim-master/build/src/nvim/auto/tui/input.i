# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.h" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/.deps/usr/include/termkey.h" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/.deps/usr/include/termkey.h" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/stream.h" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/stream.h" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/aucmd.h" 1
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/input.h" 1
# 18 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
# 22 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c" 2
...
void tinput_init(TermInput *input, Loop *loop)
{
  ...
  input->ttimeout = (_Bool)p_ttimeout;
  input->ttimeoutlen = p_ttm;
  input->key_buffer = rbuffer_new(0xfff);
  uv_mutex_init(&input->key_buffer_mutex);
  uv_cond_init(&input->key_buffer_cond);
# 59 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c"
  if (!os_isatty(input->in_fd) && os_isatty(2)) {
    input->in_fd = 2;
  }
  ...
  termkey_hook_terminfo_getstr(input->tk, input->tk_ti_hook_fn, ((void*)0));
...
void tinput_destroy(TermInput *input)
{
  ...
  time_watcher_close(&input->timer_handle, ((void*)0));
  stream_close(&input->read_stream, ((void*)0), ((void*)0));
...
static void forward_simple_utf8(TermInput *input, TermKeyKey *key)
{
  ...
  while (*ptr) {
    if (*ptr == '<') {
      len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "<lt>");
    } else {
      buf[len++] = *ptr;
    }
    ptr++;
...
static void forward_modified_utf8(TermInput *input, TermKeyKey *key)
{
  ...
  if (key->type == TERMKEY_TYPE_KEYSYM
    ...
    len = (size_t)__builtin___snprintf_chk (buf, sizeof(buf), 0, __builtin_object_size (buf, 1 > 1 ? 1 : 0), "<C-Z>");
  } else if (key->type != TERMKEY_TYPE_UNICODE) {
    len = termkey_strfkey(input->tk, buf, sizeof(buf), key, (TermKeyFormat)(TERMKEY_FORMAT_ALTISMETA|TERMKEY_FORMAT_WRAPBRACKET));
  } else {
    (__builtin_expect(!(key->modifiers), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c", 215, "key->modifiers") : (void)0);
    ...
    if ((key->modifiers & TERMKEY_KEYMOD_CTRL)
      ...
      (__builtin_expect(!(len <= 62), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c", 223, "len <= 62") : (void)0);

      __builtin___memmove_chk (buf + 3, buf + 1, len - 1, __builtin_object_size (buf + 3, 0));
      buf[1] = 'S';
      buf[2] = '-';
      len += 2;
    }
...
static void forward_mouse_event(TermInput *input, TermKeyKey *key)
{
  ...
  if (key->modifiers & TERMKEY_KEYMOD_SHIFT) {
    len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "S-");
  }

  if (key->modifiers & TERMKEY_KEYMOD_CTRL) {
    len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "C-");
  }

  if (key->modifiers & TERMKEY_KEYMOD_ALT) {
    len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "A-");
  }

  if (button == 1) {
    len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "Left");
  } else if (button == 2) {
    len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "Middle");
  } else if (button == 3) {
    len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "Right");
  }

  switch (ev) {
    case TERMKEY_MOUSE_PRESS:
      if (button == 4) {
        len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "ScrollWheelUp");
      } else if (button == 5) {
        len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "ScrollWheelDown");

      } else {
        len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "Mouse");
        last_pressed_button = button;
      }
      break;
    case TERMKEY_MOUSE_DRAG:
      len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "Drag");
      break;
    case TERMKEY_MOUSE_RELEASE:
      len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "Release");
      break;
    case TERMKEY_MOUSE_UNKNOWN:
      abort();
  }

  len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "><%d,%d>", col, row);
  tinput_enqueue(input, buf, len);
}
...
static void tinput_timer_cb(TimeWatcher *watcher, void *data)
{
  ...
  if (rbuffer_size(input->read_stream.buffer)) {
    handle_raw_buffer(input, 1);
  }
  tk_getkeys(input, 1);
  tinput_flush(input, 1);
}
# 368 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c"
static _Bool handle_focus_event(TermInput *input)
{
  if (rbuffer_size(input->read_stream.buffer) > 2
    ...
    _Bool focus_gained = *rbuffer_get(input->read_stream.buffer, 2) == 'I';
...
static HandleState handle_bracketed_paste(TermInput *input)
{
  ...
  if (buf_size > 5
    ...
    _Bool enable = *rbuffer_get(input->read_stream.buffer, 4) == '0';
...
# 467 "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c"
  ...
  do {
    ...
    if (input->paste) {
      for (size_t len = 0, _r = 1; _r; _r = 0) for ( char *ptr = rbuffer_read_ptr(input->read_stream.buffer, &len); input->read_stream.buffer->size; ptr = rbuffer_read_ptr(input->read_stream.buffer, &len)) {
        size_t consumed = (((count)<(len))?(count):(len));
        (__builtin_expect(!(consumed <= input->read_stream.buffer->size), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c", 594, "consumed <= input->read_stream.buffer->size") : (void)0);
    ...
    for (size_t len = 0, _r = 1; _r; _r = 0) for ( char *ptr = rbuffer_read_ptr(input->read_stream.buffer, &len); input->read_stream.buffer->size; ptr = rbuffer_read_ptr(input->read_stream.buffer, &len)) {
      size_t consumed = termkey_push_bytes(input->tk, ptr, (((count)<(len))?(count):(len)));



      (__builtin_expect(!(consumed <= input->read_stream.buffer->size), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/tui/input.c", 609, "consumed <= input->read_stream.buffer->size") : (void)0);
      rbuffer_consumed(input->read_stream.buffer, consumed);
