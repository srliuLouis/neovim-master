# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/buffer_updates.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/buffer_updates.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/buffer_updates.h" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/buffer_updates.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memline.h" 1
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/buffer_updates.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/buffer_updates.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/buffer_updates.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/buffer_updates.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/assert.h" 1
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/buffer_updates.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/buffer_updates.c" 2
...
_Bool buf_updates_register(buf_T *buf, uint64_t channel_id,
                          BufUpdateCallbacks cb, _Bool send_buffer)
{
  ...
  if (send_buffer) {
    ...
    Array linedata = {.size = 0, .capacity = 0, .items = ((void*)0)};



    do { _Static_assert(18446744073709551615UL >= MAXLNUM, "size_t smaller than MAXLNUM"); } while (0);
    ...
    if (line_count >= 1) {
      ...
      buf_collect_lines(buf, line_count, 1, 1, &linedata, ((void*)0));
    }

    args.items[4] = ((Object) { .type = kObjectTypeArray, .data.array = linedata });
    args.items[5] = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 0 });
...
void buf_updates_unload(buf_T *buf, _Bool can_reload)
{
  ...
  for (size_t i = 0; i < ((buf->update_callbacks).size); i++) {
    ...
    if (thecb != (-2)) {
      ...
      textlock++;
      nlua_call_ref(thecb, keep ? "reload" : "detach", args, 0, ((void*)0));
      textlock--;
    }
                              ...
                              _Bool send_tick)
{
  ...
  for (size_t i = 0; i < ((buf->update_channels).size); i++) {
    ...
    if (num_added > 0) {
        ...
        buf_collect_lines(buf, (size_t)num_added, firstline, 1, &linedata,
                          ((void*)0));
    }
    args.items[4] = ((Object) { .type = kObjectTypeArray, .data.array = linedata });
    args.items[5] = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 0 });
  ...
  if (badchannelid != 0) {
    logmsg(4, ((void*)0), __func__, 251, 1, "Disabling buffer updates for dead channel %""ll" "u", badchannelid);
  ...
  for (size_t i = 0; i < ((buf->update_callbacks).size); i++) {
    ...
    if (cb.on_lines != (-2) && (cb.preview || !(State & 0x4000))) {
      ...
      textlock++;
      Object res = nlua_call_ref(cb.on_lines, "lines", args, 1, ((void*)0));
      textlock--;

      if (res.type == kObjectTypeBoolean && res.data.boolean == 1) {
        buffer_update_callbacks_free(cb);
        keep = 0;
      }
      api_free_object(res);
    ...
    int new_row, colnr_T new_col, bcount_t new_byte)
{
  ...
  for (size_t i = 0; i < ((buf->update_callbacks).size); i++) {
    ...
    if (cb.on_bytes != (-2) && (cb.preview || !(State & 0x4000))) {
      Array args = {.size = 0, .capacity = 0, .items = ((void*)0)}; Object args__items[11]; args.size = 11; args.items = args__items;;
      ...
      textlock++;
      Object res = nlua_call_ref(cb.on_bytes, "bytes", args, 1, ((void*)0));
      textlock--;
...
void buf_updates_changedtick(buf_T *buf)
{
  ...
  for (size_t i = 0; i < ((buf->update_callbacks).size); i++) {
    ...
    if (cb.on_changedtick != (-2)) {
      Array args = {.size = 0, .capacity = 0, .items = ((void*)0)}; Object args__items[2]; args.size = 2; args.items = args__items;;
