# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/private/handle.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/private/handle.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/private/handle.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/private/handle.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/private/handle.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/private/handle.c" 2
# 31 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/private/handle.c"
static Map_handle_T_ptr_t *buffer_handles = ((void*)0); buf_T *handle_get_buffer(handle_T handle) { return map_handle_T_ptr_t_get(buffer_handles, handle); } void handle_register_buffer(buf_T *buffer) { map_handle_T_ptr_t_put(buffer_handles, buffer->handle, buffer); } void handle_unregister_buffer(buf_T *buffer) { map_handle_T_ptr_t_del(buffer_handles, buffer->handle); }
static Map_handle_T_ptr_t *window_handles = ((void*)0); win_T *handle_get_window(handle_T handle) { return map_handle_T_ptr_t_get(window_handles, handle); } void handle_register_window(win_T *window) { map_handle_T_ptr_t_put(window_handles, window->handle, window); } void handle_unregister_window(win_T *window) { map_handle_T_ptr_t_del(window_handles, window->handle); }
static Map_handle_T_ptr_t *tabpage_handles = ((void*)0); tabpage_T *handle_get_tabpage(handle_T handle) { return map_handle_T_ptr_t_get(tabpage_handles, handle); } void handle_register_tabpage(tabpage_T *tabpage) { map_handle_T_ptr_t_put(tabpage_handles, tabpage->handle, tabpage); } void handle_unregister_tabpage(tabpage_T *tabpage) { map_handle_T_ptr_t_del(tabpage_handles, tabpage->handle); }
