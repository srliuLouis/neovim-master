# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.h" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.h" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.h" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/socket.h" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/event/process.h" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.h" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.h" 1
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
...
# 21 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c" 2
...
static garray_T watchers = { 0, 0, 0, 1, ((void*)0) };
...
_Bool server_init(const char *listen_addr)
{
  ...
  int rv = listen_addr == ((void*)0) ? 1 : server_start(listen_addr);

  if (0 != rv) {
    rv = env_addr == ((void*)0) ? 1 : server_start(env_addr);
    if (0 != rv) {
...
{
  do { garray_T *_gap = (&watchers); if (_gap->ga_data != ((void*)0)) { for (int i = 0; i < _gap->ga_len; i++) { SocketWatcher * *_item = &(((SocketWatcher * *)_gap->ga_data)[i]); close_socket_watcher(_item); } } ga_clear(_gap); } while (0);
}
# 87 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c"
...
# 125 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/server.c"
int server_start(const char *endpoint)
{
  if (endpoint == ((void*)0) || endpoint[0] == '\0') {
    logmsg(3, ((void*)0), __func__, 128, 1, "Empty or NULL endpoint");
    return 1;
  }
  ...
  for (int i = 0; i < watchers.ga_len; i++) {
    if (!strcmp(watcher->addr, ((SocketWatcher **)watchers.ga_data)[i]->addr)) {
      logmsg(4, ((void*)0), __func__, 143, 1, "Already listening on %s", watcher->addr);
  ...
  if (result < 0) {
    logmsg(3, ((void*)0), __func__, 154, 1, "Failed to start server: %s: %s", uv_strerror(result), watcher->addr);
    socket_watcher_close(watcher, free_server);
    return result;
  }
...
_Bool server_stop(char *endpoint)
{
  ...
  if (!watcher_found) {
    logmsg(3, ((void*)0), __func__, 199, 1, "Not listening on %s", addr);
    return 0;
  }
...
{
  if (result) {
    logmsg(4, ((void*)0), __func__, 245, 1, "Failed to accept connection: %s", uv_strerror(result));
    return;
  }
