# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2



# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stdbool.h" 1 3
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/ui.h" 1
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 22 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 25 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 27 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os_unix.h" 2
# 28 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2



# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/misc1.h" 1
# 32 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/input.h" 1
# 34 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
# 35 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c" 2
...
static Map_cstr_t_ptr_t *event_strings = ((void*)0);
...
void rpc_start(Channel *channel)
{
  ...
  rpc->info = (Dictionary){.size = 0, .capacity = 0, .items = ((void*)0)};
...
# 121 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c"
                     ...
                     Error *err)
{
  ...
  if (!(channel = find_rpc_channel(id))) {
    api_set_error(err, kErrorTypeException, "Invalid channel: %" "ll" "u", id);
    api_free_array(args);
  ...
  ChannelCallFrame frame = { request_id, 0, 0, ((Object){ .type = kObjectTypeNil }) };
                            ...
                            void *data, _Bool eof)
{
  ...
  if (eof) {
    channel_close(channel->id, kChannelPartRpc, ((void*)0));
    char buf[256];
    __builtin___snprintf_chk (buf, sizeof(buf), 0, __builtin_object_size (buf, 1 > 1 ? 1 : 0), "ch %" "ll" "u" " was closed by the client", channel->id);
...
static void parse_msgpack(Channel *channel)
{
  ...
  while ((result = msgpack_unpacker_next(channel->rpc.unpacker, &unpacked)) ==
    ...
    _Bool is_response = is_rpc_response(&unpacked.data);
                                                            ;
    ...
    if (is_response) {
      if (is_valid_rpc_response(&unpacked.data, channel)) {
        ...
        char buf[256];
        __builtin___snprintf_chk (buf, sizeof(buf), 0, __builtin_object_size (buf, 1 > 1 ? 1 : 0), "ch %" "ll" "u" " returned a response with an unknown request " "id. Ensure the client is properly synchronized", channel->id);
...
{
  uint32_t request_id;
  Error error = { .type = kErrorTypeNone, .msg = ((void*)0) };
  ...
  if (((&error)->type != kErrorTypeNone)) {
    ...
    if (channel_write(channel,
                      serialize_response(channel->id,
                                         ...
                                         &out_buffer))) {
      char buf[256];
      __builtin___snprintf_chk (buf, sizeof(buf), 0, __builtin_object_size (buf, 1 > 1 ? 1 : 0), "ch %" "ll" "u" " sent an invalid message, closed.", channel->id);
  ...
  (__builtin_expect(!(type == kMessageTypeRequest || type == kMessageTypeNotification), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/channel.c", 317, "type == kMessageTypeRequest || type == kMessageTypeNotification") : (void)0);
  ...
  channel_incref(channel);
  if (handler.fast) {
    _Bool is_get_mode = handler.fn == handle_nvim_get_mode;
    ...
    _Bool is_resize = handler.fn == handle_nvim_ui_try_resize;
    if (is_resize) {
...
static _Bool channel_write(Channel *channel, WBuffer *buffer)
{
  ...
  if (!success) {
    ...
    char buf[256];
    __builtin___snprintf_chk (buf, sizeof(buf), 0, __builtin_object_size (buf, 1 > 1 ? 1 : 0), "ch %" "ll" "u" ": stream write failed. " "RPC canceled; closing channel", channel->id);
...
static void internal_read_event(void **argv)
{
  ...
  __builtin___memcpy_chk (msgpack_unpacker_buffer(channel->rpc.unpacker), buffer->data, buffer->size, __builtin_object_size (msgpack_unpacker_buffer(channel->rpc.unpacker), 0));
...
{
  Error e = { .type = kErrorTypeNone, .msg = ((void*)0) };
...
{
  struct { size_t size; size_t capacity; Channel * *items; } subscribed = { .size = 0, .capacity = 0, .items = ((void*)0) };
  Channel *channel;
...
static void unsubscribe(Channel *channel, char *event)
{
  char *event_string = map_cstr_t_ptr_t_get(event_strings, event);
  if (!event_string) {
      logmsg(3, ((void*)0), __func__, 534, 1, "RPC: ch %" "ll" "u" ": tried to unsubscribe unknown event '%s'", channel->id, event);
...
{
  logmsg((loglevel), ((void*)0), __func__, 627, 1, "RPC: %s", msg);
