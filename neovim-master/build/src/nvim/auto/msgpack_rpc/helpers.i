# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c" 2



# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stdbool.h" 1 3
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/api/private/dispatch.h" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c" 2




# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/assert.h" 1
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c" 2
...
# 62 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c"
...
static _Bool msgpack_rpc_to_buffer(const msgpack_object *const obj, Integer *const arg) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT { if (obj->type != MSGPACK_OBJECT_EXT || obj->via.ext.type + kObjectTypeBuffer != kObjectTypeBuffer) { return 0; } msgpack_object data; msgpack_unpack_return ret = msgpack_unpack(obj->via.ext.ptr, obj->via.ext.size, ((void*)0), &zone, &data); if (ret != MSGPACK_UNPACK_SUCCESS) { return 0; } *arg = (handle_T)data.via.i64; return 1; } static void msgpack_rpc_from_buffer(Integer o, msgpack_packer *res) FUNC_ATTR_NONNULL_ARG(2) { msgpack_packer pac; msgpack_packer_init(&pac, &sbuffer, msgpack_sbuffer_write); msgpack_pack_int64(&pac, (handle_T)o); msgpack_pack_ext(res, sbuffer.size, kObjectTypeBuffer - kObjectTypeBuffer); msgpack_pack_ext_body(res, sbuffer.data, sbuffer.size); msgpack_sbuffer_clear(&sbuffer); }
static _Bool msgpack_rpc_to_window(const msgpack_object *const obj, Integer *const arg) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT { if (obj->type != MSGPACK_OBJECT_EXT || obj->via.ext.type + kObjectTypeBuffer != kObjectTypeWindow) { return 0; } msgpack_object data; msgpack_unpack_return ret = msgpack_unpack(obj->via.ext.ptr, obj->via.ext.size, ((void*)0), &zone, &data); if (ret != MSGPACK_UNPACK_SUCCESS) { return 0; } *arg = (handle_T)data.via.i64; return 1; } static void msgpack_rpc_from_window(Integer o, msgpack_packer *res) FUNC_ATTR_NONNULL_ARG(2) { msgpack_packer pac; msgpack_packer_init(&pac, &sbuffer, msgpack_sbuffer_write); msgpack_pack_int64(&pac, (handle_T)o); msgpack_pack_ext(res, sbuffer.size, kObjectTypeWindow - kObjectTypeBuffer); msgpack_pack_ext_body(res, sbuffer.data, sbuffer.size); msgpack_sbuffer_clear(&sbuffer); }
static _Bool msgpack_rpc_to_tabpage(const msgpack_object *const obj, Integer *const arg) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT { if (obj->type != MSGPACK_OBJECT_EXT || obj->via.ext.type + kObjectTypeBuffer != kObjectTypeTabpage) { return 0; } msgpack_object data; msgpack_unpack_return ret = msgpack_unpack(obj->via.ext.ptr, obj->via.ext.size, ((void*)0), &zone, &data); if (ret != MSGPACK_UNPACK_SUCCESS) { return 0; } *arg = (handle_T)data.via.i64; return 1; } static void msgpack_rpc_from_tabpage(Integer o, msgpack_packer *res) FUNC_ATTR_NONNULL_ARG(2) { msgpack_packer pac; msgpack_packer_init(&pac, &sbuffer, msgpack_sbuffer_write); msgpack_pack_int64(&pac, (handle_T)o); msgpack_pack_ext(res, sbuffer.size, kObjectTypeTabpage - kObjectTypeBuffer); msgpack_pack_ext_body(res, sbuffer.data, sbuffer.size); msgpack_sbuffer_clear(&sbuffer); }
...
_Bool msgpack_rpc_to_object(const msgpack_object *const obj, Object *const arg)
  FUNC_ATTR_NONNULL_ALL
{
  _Bool ret = 1;
  struct { size_t size; size_t capacity; MPToAPIObjectStackItem *items; } stack = { .size = 0, .capacity = 0, .items = ((void*)0) };
  (*((((stack).size == (stack).capacity) ? (((stack).capacity = ((stack).capacity ? (stack).capacity << 1 : 8), (stack).items = xrealloc((stack).items, sizeof((stack).items[0]) * (stack).capacity)), 0) : 0), ((stack).items + ((stack).size++))) = (((MPToAPIObjectStackItem) { .mobj = obj, .aobj = arg, .container = 0, .idx = 0, })));
  ...
  while (ret && ((stack).size)) {
    ...
    switch (cur.mobj->type) {
      ...
      case MSGPACK_OBJECT_POSITIVE_INTEGER: {
        ...
        if (cur.mobj->via.u64 > 9223372036854775807LL) {
          ret = 0;
        } else {
...
# 147 "/Users/shi-rongliu/tool/neovim-master/src/nvim/msgpack_rpc/helpers.c"
      case MSGPACK_OBJECT_STR: { *cur.aobj = ((Object) { .type = kObjectTypeString, .data.string = ((String) { .size = cur.mobj->via.str.size, .data = (cur.mobj->via.str.ptr == ((void*)0) || cur.mobj->via.str.size == 0 ? xmemdupz("", 0) : xmemdupz(cur.mobj->via.str.ptr, cur.mobj->via.str.size)), }) }); break; }
      case MSGPACK_OBJECT_BIN: { *cur.aobj = ((Object) { .type = kObjectTypeString, .data.string = ((String) { .size = cur.mobj->via.bin.size, .data = (cur.mobj->via.bin.ptr == ((void*)0) || cur.mobj->via.bin.size == 0 ? xmemdupz("", 0) : xmemdupz(cur.mobj->via.bin.ptr, cur.mobj->via.bin.size)), }) }); break; }
      case MSGPACK_OBJECT_ARRAY: {
        ...
        if (cur.container) {
          if (cur.idx >= size) {
            ...
            (*((((stack).size == (stack).capacity) ? (((stack).capacity = ((stack).capacity ? (stack).capacity << 1 : 8), (stack).items = xrealloc((stack).items, sizeof((stack).items[0]) * (stack).capacity)), 0) : 0), ((stack).items + ((stack).size++))) = (((MPToAPIObjectStackItem) { .mobj = &cur.mobj->via.array.ptr[idx], .aobj = &cur.aobj->data.array.items[idx], .container = 0, })));
          ...
          *cur.aobj = ((Object) { .type = kObjectTypeArray, .data.array = ((Array) { .size = size, .capacity = size, .items = (size > 0 ? xcalloc(size, sizeof(*cur.aobj->data.array.items)) : ((void*)0)), }) });
        ...
        if (cur.container) {
          if (cur.idx >= size) {
            ...
            switch (key->type) {
              ...
              case MSGPACK_OBJECT_STR: { cur.aobj->data.dictionary.items[idx].key = ((String) { .size = key->via.str.size, .data = (key->via.str.ptr == ((void*)0) || key->via.str.size == 0 ? xmemdupz("", 0) : xmemdupz(key->via.str.ptr, key->via.str.size)), }); break; }

              case MSGPACK_OBJECT_BIN: { cur.aobj->data.dictionary.items[idx].key = ((String) { .size = key->via.bin.size, .data = (key->via.bin.ptr == ((void*)0) || key->via.bin.size == 0 ? xmemdupz("", 0) : xmemdupz(key->via.bin.ptr, key->via.bin.size)), }); break; }
            ...
            if (ret) {
              (*((((stack).size == (stack).capacity) ? (((stack).capacity = ((stack).capacity ? (stack).capacity << 1 : 8), (stack).items = xrealloc((stack).items, sizeof((stack).items[0]) * (stack).capacity)), 0) : 0), ((stack).items + ((stack).size++))) = (((MPToAPIObjectStackItem) { .mobj = &cur.mobj->via.map.ptr[idx].val, .aobj = &cur.aobj->data.dictionary.items[idx].value, .container = 0, })));
          ...
          *cur.aobj = ((Object) { .type = kObjectTypeDictionary, .data.dictionary = ((Dictionary) { .size = size, .capacity = size, .items = (size > 0 ? xcalloc(size, sizeof(*cur.aobj->data.dictionary.items)) : ((void*)0)), }) });
...
static _Bool msgpack_rpc_to_string(const msgpack_object *const obj,
                                  String *const arg)
  FUNC_ATTR_NONNULL_ALL
{
  if (obj->type == MSGPACK_OBJECT_BIN || obj->type == MSGPACK_OBJECT_STR) {
    arg->data = obj->via.bin.ptr != ((void*)0)
...
_Bool msgpack_rpc_to_array(const msgpack_object *const obj, Array *const arg)
  FUNC_ATTR_NONNULL_ALL
{
...
_Bool msgpack_rpc_to_dictionary(const msgpack_object *const obj,
...
void msgpack_rpc_from_object(const Object result, msgpack_packer *const res)
  FUNC_ATTR_NONNULL_ARG(2)
{
  struct { size_t size; size_t capacity; APIToMPObjectStackItem *items; } stack = { .size = 0, .capacity = 0, .items = ((void*)0) };
  (*((((stack).size == (stack).capacity) ? (((stack).capacity = ((stack).capacity ? (stack).capacity << 1 : 8), (stack).items = xrealloc((stack).items, sizeof((stack).items[0]) * (stack).capacity)), 0) : 0), ((stack).items + ((stack).size++))) = (((APIToMPObjectStackItem) { &result, 0, 0 })));
  while (((stack).size)) {
      ...
      case kObjectTypeArray: {
        ...
        if (cur.container) {
          if (cur.idx >= size) {
            ...
            cur.idx++;
            ((stack).items[(((stack).size) - (0) - 1)]) = cur;
            (*((((stack).size == (stack).capacity) ? (((stack).capacity = ((stack).capacity ? (stack).capacity << 1 : 8), (stack).items = xrealloc((stack).items, sizeof((stack).items[0]) * (stack).capacity)), 0) : 0), ((stack).items + ((stack).size++))) = (((APIToMPObjectStackItem) { .aobj = &cur.aobj->data.array.items[idx], .container = 0, })));
        ...
        if (cur.container) {
          if (cur.idx >= size) {
            ...
            msgpack_rpc_from_string(cur.aobj->data.dictionary.items[idx].key,
                                    res);
            (*((((stack).size == (stack).capacity) ? (((stack).capacity = ((stack).capacity ? (stack).capacity << 1 : 8), (stack).items = xrealloc((stack).items, sizeof((stack).items[0]) * (stack).capacity)), 0) : 0), ((stack).items + ((stack).size++))) = (((APIToMPObjectStackItem) { .aobj = &cur.aobj->data.dictionary.items[idx].value, .container = 0, })));
...
msgpack_object *msgpack_rpc_args(msgpack_object *req)
{
  ...
  return obj->type == MSGPACK_OBJECT_ARRAY ? obj : ((void*)0);
}
...
static msgpack_object *msgpack_rpc_msg_id(msgpack_object *req)
{
  ...
  return obj->type == MSGPACK_OBJECT_POSITIVE_INTEGER ? obj : ((void*)0);
}
