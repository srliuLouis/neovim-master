# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c" 2


# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/mouse.h" 1
# 18 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c" 2
# 27 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c"
...
# 370 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c"
...
char_u *get_special_key_name(int c, int modifiers)
{
  ...
  if (table_idx < 0) {
    ...
    if ((int)len + idx + 2 <= 32) {
        __builtin___strcpy_chk ((char *)(string + idx), (char *)(key_names_table[table_idx].name), __builtin_object_size ((char *)(string + idx), 1 > 1 ? 1 : 0));
        idx += (int)len;
    }
  }
  string[idx++] = '>';
...
# 527 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c"
unsigned int trans_special(const char_u **srcp, const size_t src_len,
                           char_u *const dst, const _Bool keycode,
                           const _Bool in_string)
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT
{
  int modifiers = 0;
  int key;

  key = find_special_key(srcp, src_len, &modifiers, keycode, 0, in_string);
  if (key == 0) {
    return 0;
  }
...
unsigned int special_to_buf(int key, int modifiers, _Bool keycode, char_u *dst)
{
  ...
  if (((key) < 0)) {
    ...
    (__builtin_expect(!(after >= dst && (uintmax_t)(after - dst) <= (2147483647 *2U +1U)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c", 567, "after >= dst && (uintmax_t)(after - dst) <= UINT_MAX") : (void)0);
    dlen = (unsigned int)(after - dst);
  }

  return dlen;
}
# 584 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c"
int find_special_key(const char_u **srcp, const size_t src_len, int *const modp,
                     const _Bool keycode, const _Bool keep_x_key,
                     const _Bool in_string)
  FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ALL
{
  ...
  for (bp = src + 1; bp <= end && (*bp == '-' || ascii_isident(*bp)); bp++) {
    ...
    if (end - bp > 3 && bp[0] == 't' && bp[1] == '_') {
      ...
      vim_str2nr(bp + 5, ((void*)0), &l, STR2NR_ALL, ((void*)0), ((void*)0), 0);
      bp += l + 5;
      break;
    }
  }
  ...
  if (bp <= end && *bp == '>') {
    ...
    if (bp >= last_dash) {
      if (strncasecmp((char *)(last_dash + 1), (char *)("char-"), (size_t)(5)) == 0
        ...
        vim_str2nr(last_dash + 6, ((void*)0), ((void*)0), STR2NR_ALL, ((void*)0), &n, 0);
        key = (int)n;
      } else {
        int off = 1;
...
int find_special_key_in_table(int c)
{
  ...
  for (i = 0; key_names_table[i].name != ((void*)0); i++) {
    if (c == key_names_table[i].key) {
      break;
    }
  }
  if (key_names_table[i].name == ((void*)0)) {
    i = -1;
  }
  return i;
}
# 762 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c"
int get_special_key_code(const char_u *name)
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT
{
  for (int i = 0; key_names_table[i].name != ((void*)0); i++) {
...
# 823 "/Users/shi-rongliu/tool/neovim-master/src/nvim/keymap.c"
char_u *replace_termcodes(const char_u *from, const size_t from_len,
                          char_u **bufp, const _Bool from_part, const _Bool do_lt,
                          const _Bool special, int cpo_flags)
  FUNC_ATTR_NONNULL_ALL
{
  ssize_t i;
  size_t slen;
  ...
  while (src <= end) {
    ...
    if (special && (do_lt || ((end - src) >= 3
      ...
      if (end - src >= 4 && strncasecmp((char *)(src), (char *)("<SID>"), (size_t)(5)) == 0) {
        if (current_sctx.sc_sid <= 0) {
          ...
          __builtin___snprintf_chk ((char *)result + dlen, buf_len - dlen, 0, __builtin_object_size ((char *)result + dlen, 1 > 1 ? 1 : 0), "%" "ll" "d", (int64_t)current_sctx.sc_sid);
      ...
      slen = trans_special(&src, (size_t)(end - src) + 1, result + dlen, 1,
                           0);
      if (slen) {
        dlen += slen;
        continue;
    ...
    if (special) {
      ...
      if (len != 0) {
        ...
        if (p == ((void*)0) || *p == '\000' || strlen((char *)(p)) > 8 * 6) {
          s = (char_u *)"\\";
        } else {
          s = p;
        }
...
void log_key(int log_level, int key)
{
  ...
  logmsg((log_level), ((void*)0), __func__, 968, 1, "input: %s", keyname);
}
