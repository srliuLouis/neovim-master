# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/garray.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/garray.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/garray.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/garray.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/garray.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/garray.c" 2
...
# 21 "/Users/shi-rongliu/tool/neovim-master/src/nvim/garray.c" 2
...
{
  if (growsize < 1) {
    logmsg(3, ((void*)0), __func__, 66, 1, "trying to set an invalid ga_growsize: %d", growsize);
    gap->ga_growsize = 1;
  } else {
...
void ga_grow(garray_T *gap, int n)
{
  ...
  if (gap->ga_growsize < 1) {
    logmsg(3, ((void*)0), __func__, 85, 1, "ga_growsize(%d) is less than 1", gap->ga_growsize);
  }
  ...
  __builtin___memset_chk (pp + old_size, 0, new_size - old_size, __builtin_object_size (pp + old_size, 0));
...
# 146 "/Users/shi-rongliu/tool/neovim-master/src/nvim/garray.c"
  ...
  FUNC_ATTR_NONNULL_RET
{
  ...
  __builtin___strcpy_chk (s, strings[nelem - 1], __builtin_object_size (s, 1 > 1 ? 1 : 0));
...
# 195 "/Users/shi-rongliu/tool/neovim-master/src/nvim/garray.c"
  ...
  FUNC_ATTR_NONNULL_ALL
{
  if (len) {
    ...
    __builtin___memcpy_chk (data + gap->ga_len, s, len, __builtin_object_size (data + gap->ga_len, 0));
    gap->ga_len += (int) len;
  }
}
