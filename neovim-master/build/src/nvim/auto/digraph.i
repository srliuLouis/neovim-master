# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stdbool.h" 1 3
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
# 14 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.h" 1
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
# 19 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
# 20 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
# 21 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
# 27 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/input.h" 1
# 29 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c" 2
...
static garray_T user_digraphs = {0, 0, (int)sizeof(digr_T), 10, ((void*)0)};
...
int get_digraph(int cmdline)
{
  ...
  if (c != '\033') {
    ...
    if (cc != '\033') {
      ...
      return getdigraph(c, cc, 1);
    }
  }
  return '\000';
}
# 1549 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c"
...
# 1599 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c"
...
void putdigraph(char_u *str)
{
  ...
  while (*str != '\000') {
    ...
    if ((char1 == '\033') || (char2 == '\033')) {
      emsg((char_u *)(libintl_gettext((char *)("E104: Escape not allowed in digraph"))));
      return;
    }
    str = skipwhite(str);
...
void listdigraphs(_Bool use_headers)
{
  ...
  for (int i = 0; dp->char1 != '\000' && !got_int; ++i) {
    ...
    tmp.char1 = dp->char1;
    tmp.char2 = dp->char2;
    tmp.result = getexactdigraph(tmp.char1, tmp.char2, 0);

    if ((tmp.result != 0)
        && (tmp.result != tmp.char2)) {
      printdigraph(&tmp, use_headers ? &previous : ((void*)0));
    }
    dp++;
    fast_breakcheck();
  }
  ...
  for (int i = 0; i < user_digraphs.ga_len && !got_int; i++) {
    if (previous >= 0 && use_headers) {
      digraph_header(libintl_gettext((char *)("Custom")));
    }
    previous = -1;
    printdigraph(dp, ((void*)0));
    fast_breakcheck();
    dp++;
  }
}
  ...
  FUNC_ATTR_NONNULL_ARG(1)
{
  ...
  if (dp->result != 0) {
    if (previous != ((void*)0)) {
      for (int i = 0; header_table[i].dg_header != ((void*)0); i++) {
        if (*previous < header_table[i].dg_start
            && dp->result >= header_table[i].dg_start
            && dp->result < header_table[i + 1].dg_start) {
          digraph_header(libintl_gettext((char *)(header_table[i].dg_header)));
          break;
        }
      }
      *previous = dp->result;
    ...
    *p = '\000';
    ...
    (__builtin_expect(!(p >= buf), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c", 1804, "p >= buf") : (void)0);
...
# 1824 "/Users/shi-rongliu/tool/neovim-master/src/nvim/digraph.c"
...
void ex_loadkeymap(exarg_T *eap)
{
  ...
  if (!getline_equal(eap->getline, eap->cookie, getsourceline)) {
    emsg((char_u *)(libintl_gettext((char *)("E105: Using :loadkeymap not in a sourced file"))));
    return;
  }
  ...
  for (;;) {
    line = eap->getline(0, eap->cookie, 0, 1);
    ...
    if ((*p != '"') && (*p != '\000')) {
      ...
      if ((strlen((char *)(kp->from)) + strlen((char *)(kp->to)) >= 200)
          ...
          || (*kp->to == '\000')) {
        if (*kp->to == '\000') {
          emsg((char_u *)(libintl_gettext((char *)("E791: Empty keymap entry"))));
        }
        xfree(kp->from);
        xfree(kp->to);
