# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c" 2
...
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c" 2
...
# 55 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c"
...
# 100 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c"
static inline int json_decoder_pop(ValuesStackItem obj,
                                   ValuesStack *const stack,
                                   ContainerStack *const container_stack,
                                   const char **const pp,
                                   _Bool *const next_map_special,
                                   _Bool *const didcomma,
                                   _Bool *const didcolon)
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (last_container.container.v_type == VAR_LIST) {
    if (tv_list_len(last_container.container.vval.v_list) != 0
        && !obj.didcomma) {
      emsgf((const char *) (libintl_gettext((char *)("E474: Expected comma before list item: %s"))), (val_location));
      tv_clear(&obj.val);
      return 0;
    }
    (__builtin_expect(!(last_container.special_val == ((void*)0)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c", 130, "last_container.special_val == NULL") : (void)0);
    tv_list_append_owned_tv(last_container.container.vval.v_list, obj.val);
  } else if (last_container.stack_index == ((*stack).size) - 2) {
    if (!obj.didcolon) {
      emsgf((const char *) (libintl_gettext((char *)("E474: Expected colon before dictionary value: %s"))), (val_location));

      tv_clear(&obj.val);
      return 0;
    }
    ValuesStackItem key = ((*stack).items[--(*stack).size]);
    if (last_container.special_val == ((void*)0)) {

      (__builtin_expect(!(!(key.is_special_string || key.val.vval.v_string == ((void*)0) || *key.val.vval.v_string == '\000')), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c", 144, "!(key.is_special_string || key.val.vval.v_string == NULL || *key.val.vval.v_string == NUL)") : (void)0);
    ...
    if (!obj.is_special_string && obj.val.v_type != VAR_STRING) {
      emsgf((const char *) (libintl_gettext((char *)("E474: Expected string key: %s"))), (*pp));
      tv_clear(&obj.val);
      return 0;
    } else if (!obj.didcomma
               && (last_container.special_val == ((void*)0)
                   && ((last_container.container.vval.v_dict)->dv_hashtab.ht_used != 0))) {
      emsgf((const char *) (libintl_gettext((char *)("E474: Expected comma before dictionary key: %s"))), (val_location));
      tv_clear(&obj.val);
      return 0;
    }
...
# 232 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c"
...
# 262 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c"
typval_T decode_string(const char *const s, const size_t len,
                       const TriState hasnul, const _Bool binary,
                       const _Bool s_allocated)
  FUNC_ATTR_WARN_UNUSED_RESULT
{
  (__builtin_expect(!(s != ((void*)0) || len == 0), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c", 267, "s != NULL || len == 0") : (void)0);
  const _Bool really_hasnul = (hasnul == kNone
                              ? ((s != ((void*)0)) && (memchr(s, '\000', len) != ((void*)0)))
                              : (_Bool)hasnul);
  if (really_hasnul) {
    ...
    return (typval_T) {
      ...
      .vval = { .v_string = (char_u *)(
          (s == ((void*)0) || s_allocated) ? (char *)s : xmemdupz(s, len)) },
    };
  }
}
# 317 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_ALWAYS_INLINE
{
  ...
  while (p < e && *p != '"') {
    if (*p == '\\') {
      p++;
      if (p == e) {
        emsgf(libintl_gettext((char *)("E474: Unfinished escape sequence: %.*s")),
              (int) buf_len, buf);
      ...
      switch (*p) {
        case 'u': {
          if (p + 4 >= e) {
            emsgf(libintl_gettext((char *)("E474: Unfinished unicode escape sequence: %.*s")),
                  (int) buf_len, buf);
            goto parse_json_string_fail;
                     ...
                     || !ascii_isxdigit(p[3])
                     || !ascii_isxdigit(p[4])) {
            emsgf(libintl_gettext((char *)("E474: Expected four hex digits after \\u: %.*s")),
                  ((int) ((e) - (p - 1))), (p - 1));
            goto parse_json_string_fail;
          }
        ...
        default: {
          emsgf(libintl_gettext((char *)("E474: Unknown escape sequence: %.*s")), ((int) ((e) - (p - 1))), (p - 1));
          goto parse_json_string_fail;
        }
      }
    } else {
      ...
      if (p_byte < 0x20) {
        emsgf(libintl_gettext((char *)("E474: ASCII control characters cannot be present " "inside string: %.*s")), ((int) ((e) - (p))), (p));
      ...
      if (ch >= 0x80 && p_byte == ch
        ...
        emsgf(libintl_gettext((char *)("E474: Only UTF-8 strings allowed: %.*s")), ((int) ((e) - (p))), (p));
        goto parse_json_string_fail;
      } else if (ch > 0x10FFFF) {
        emsgf(libintl_gettext((char *)("E474: Only UTF-8 code points up to U+10FFFF " "are allowed to appear unescaped: %.*s")), ((int) ((e) - (p))), (p));

        goto parse_json_string_fail;
      }
      const size_t ch_len = (size_t) utf_char2len(ch);
      (__builtin_expect(!(ch_len == (size_t) (ch ? utf_ptr2len((char_u *) p) : 1)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c", 401, "ch_len == (size_t) (ch ? utf_ptr2len((char_u *) p) : 1)") : (void)0);
      len += ch_len;
      p += ch_len;
    }
  }
  if (p == e || *p != '"') {
    emsgf(libintl_gettext((char *)("E474: Expected string end: %.*s")), (int) buf_len, buf);
    goto parse_json_string_fail;
  }
  if (len == 0) {
    do { if (json_decoder_pop(((ValuesStackItem) { .is_special_string = (0), .val = (((typval_T) { .v_type = VAR_STRING, .vval = { .v_string = ((void*)0) }, })), .didcomma = (*didcomma), .didcolon = (*didcolon), }), stack, container_stack, &p, next_map_special, didcomma, didcolon) == 0) { goto parse_json_string_fail; } if (*next_map_special) { goto parse_json_string_ret; } } while (0);
    ...
    if (*t == '\\') {
      ...
      switch (*t) {
        case 'u': {
          ...
          t += 4;
          uvarnumber_T ch;
          vim_str2nr((char_u *)ubuf, ((void*)0), ((void*)0),
                     STR2NR_HEX | STR2NR_FORCE, ((void*)0), &ch, 4);
          if (ch == 0) {
            hasnul = 1;
          }
  ...
  *str_end = '\000';
  typval_T obj = decode_string(
      str, (size_t)(str_end - str), hasnul ? kTrue : kFalse, 0, 1);
...
# 530 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_ALWAYS_INLINE
{
  ...
  int ret = 1;
  const char *const s = p;
  const char *ints = ((void*)0);
  const char *fracs = ((void*)0);
  const char *exps = ((void*)0);
  const char *exps_s = ((void*)0);
  if (*p == '-') {
    p++;
  }
  ints = p;
  ...
  if (p != ints + 1 && *ints == '0') {
    emsgf(libintl_gettext((char *)("E474: Leading zeroes are not allowed: %.*s")), ((int) ((e) - (s))), (s));
...
parse_json_number_check:
  if (p == ints) {
    emsgf(libintl_gettext((char *)("E474: Missing number after minus sign: %.*s")), ((int) ((e) - (s))), (s));
    goto parse_json_number_fail;
  } else if (p == fracs || (fracs != ((void*)0) && exps_s == fracs + 1)) {
    emsgf(libintl_gettext((char *)("E474: Missing number after decimal dot: %.*s")), ((int) ((e) - (s))), (s));
    goto parse_json_number_fail;
  } else if (p == exps) {
    emsgf(libintl_gettext((char *)("E474: Missing exponent: %.*s")), ((int) ((e) - (s))), (s));
    goto parse_json_number_fail;
  }
  typval_T tv = {
    .v_type = VAR_NUMBER,
  ...
  if (fracs || exps) {
    ...
    if (exp_num_len != num_len) {
      emsgf(libintl_gettext((char *)("E685: internal error: while converting number \"%.*s\" " "to float string2float consumed %zu bytes in place of %zu")),
    ...
    varnumber_T nr;
    int num_len;
    vim_str2nr((char_u *) s, ((void*)0), &num_len, 0, &nr, ((void*)0), (int) (p - s));
    if ((int) exp_num_len != num_len) {
      emsgf(libintl_gettext((char *)("E685: internal error: while converting number \"%.*s\" " "to integer vim_str2nr consumed %i bytes in place of %zu")),

            (int) exp_num_len, s, num_len, exp_num_len);
    }
    tv.vval.v_number = nr;
  }
  if (json_decoder_pop(((ValuesStackItem) { .is_special_string = (0), .val = (tv), .didcomma = (*didcomma), .didcolon = (*didcolon), }),
...
# 659 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT
{
  ...
  if (p == e) {
    emsg((char_u *)(libintl_gettext((char *)("E474: Attempt to decode a blank string"))));
    return 0;
  }
  int ret = 1;
  ValuesStack stack = { .size = 0, .capacity = 0, .items = ((void*)0) };
  ContainerStack container_stack = { .size = 0, .capacity = 0, .items = ((void*)0) };
  rettv->v_type = VAR_UNKNOWN;
  _Bool didcomma = 0;
  _Bool didcolon = 0;
  _Bool next_map_special = 0;
  for (; p < e; p++) {
json_decode_string_cycle_start:
    (__builtin_expect(!(*p == '{' || next_map_special == 0), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c", 681, "*p == '{' || next_map_special == false") : (void)0);
    switch (*p) {
      case '}':
      case ']': {
        if (((container_stack).size) == 0) {
          emsgf(libintl_gettext((char *)("E474: No container to close: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        }
        ContainerStackItem last_container = ((container_stack).items[(((container_stack).size) - (0) - 1)]);
        if (*p == '}' && last_container.container.v_type != VAR_DICT) {
          emsgf(libintl_gettext((char *)("E474: Closing list with curly bracket: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        } else if (*p == ']' && last_container.container.v_type != VAR_LIST) {
          emsgf(libintl_gettext((char *)("E474: Closing dictionary with square bracket: %.*s")),
                ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        } else if (didcomma) {
          emsgf(libintl_gettext((char *)("E474: Trailing comma: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        } else if (didcolon) {
          emsgf(libintl_gettext((char *)("E474: Expected value after colon: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        } else if (last_container.stack_index != ((stack).size) - 1) {
          (__builtin_expect(!(last_container.stack_index < ((stack).size) - 1), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c", 704, "last_container.stack_index < kv_size(stack) - 1") : (void)0);
          emsgf(libintl_gettext((char *)("E474: Expected value: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        }
        if (((stack).size) == 1) {
          p++;
          ...
          (__builtin_expect(!(!next_map_special), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c", 718, "!next_map_special") : (void)0);
          break;
        }
      }
      case ',': {
        if (((container_stack).size) == 0) {
          emsgf(libintl_gettext((char *)("E474: Comma not inside container: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        }
        ContainerStackItem last_container = ((container_stack).items[(((container_stack).size) - (0) - 1)]);
        if (didcomma) {
          emsgf(libintl_gettext((char *)("E474: Duplicate comma: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        } else if (didcolon) {
          emsgf(libintl_gettext((char *)("E474: Comma after colon: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        } else if (last_container.container.v_type == VAR_DICT
                   && last_container.stack_index != ((stack).size) - 1) {
          emsgf(libintl_gettext((char *)("E474: Using comma in place of colon: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        } else if (last_container.special_val == ((void*)0)
          ...
          emsgf(libintl_gettext((char *)("E474: Leading comma: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        }
        didcomma = 1;
        continue;
      ...
      case ':': {
        if (((container_stack).size) == 0) {
          emsgf(libintl_gettext((char *)("E474: Colon not inside container: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        }
        ContainerStackItem last_container = ((container_stack).items[(((container_stack).size) - (0) - 1)]);
        if (last_container.container.v_type != VAR_DICT) {
          emsgf(libintl_gettext((char *)("E474: Using colon not in dictionary: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        } else if (last_container.stack_index != ((stack).size) - 2) {
          emsgf(libintl_gettext((char *)("E474: Unexpected colon: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        } else if (didcomma) {
          emsgf(libintl_gettext((char *)("E474: Colon after comma: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        } else if (didcolon) {
          emsgf(libintl_gettext((char *)("E474: Duplicate colon: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        }
        didcolon = 1;
        continue;
      ...
      case 'n': {
        if ((p + 3) >= e || strncmp(p + 1, "ull", 3) != 0) {
          emsgf(libintl_gettext((char *)("E474: Expected null: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        }
        p += 3;
        do { if (json_decoder_pop(((ValuesStackItem) { .is_special_string = (0), .val = (((typval_T) { .v_type = VAR_SPECIAL, .v_lock = VAR_UNLOCKED, .vval = { .v_special = kSpecialVarNull }, })), .didcomma = (didcomma), .didcolon = (didcolon), }), &stack, &container_stack, &p, &next_map_special, &didcomma, &didcolon) == 0) { goto json_decode_string_fail; } if (next_map_special) { goto json_decode_string_cycle_start; } } while (0);
      ...
      case 't': {
        if ((p + 3) >= e || strncmp(p + 1, "rue", 3) != 0) {
          emsgf(libintl_gettext((char *)("E474: Expected true: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        }
        p += 3;
        do { if (json_decoder_pop(((ValuesStackItem) { .is_special_string = (0), .val = (((typval_T) { .v_type = VAR_BOOL, .v_lock = VAR_UNLOCKED, .vval = { .v_bool = kBoolVarTrue }, })), .didcomma = (didcomma), .didcolon = (didcolon), }), &stack, &container_stack, &p, &next_map_special, &didcomma, &didcolon) == 0) { goto json_decode_string_fail; } if (next_map_special) { goto json_decode_string_cycle_start; } } while (0);
      ...
      case 'f': {
        if ((p + 4) >= e || strncmp(p + 1, "alse", 4) != 0) {
          emsgf(libintl_gettext((char *)("E474: Expected false: %.*s")), ((int) ((e) - (p))), (p));
          goto json_decode_string_fail;
        }
        p += 4;
        do { if (json_decoder_pop(((ValuesStackItem) { .is_special_string = (0), .val = (((typval_T) { .v_type = VAR_BOOL, .v_lock = VAR_UNLOCKED, .vval = { .v_bool = kBoolVarFalse }, })), .didcomma = (didcomma), .didcolon = (didcolon), }), &stack, &container_stack, &p, &next_map_special, &didcomma, &didcolon) == 0) { goto json_decode_string_fail; } if (next_map_special) { goto json_decode_string_cycle_start; } } while (0);
      ...
      default: {
        emsgf(libintl_gettext((char *)("E474: Unidentified byte: %.*s")), ((int) ((e) - (p))), (p));
        goto json_decode_string_fail;
      }
    }
    didcomma = 0;
...
json_decode_string_after_cycle:
  for (; p < e; p++) {
    switch (*p) {
      ...
      default: {
        emsgf(libintl_gettext((char *)("E474: Trailing characters: %.*s")), ((int) ((e) - (p))), (p));
        goto json_decode_string_fail;
      }
    }
  }
  ...
  emsgf(libintl_gettext((char *)("E474: Unexpected end of input: %.*s")), (int) buf_len, buf);
...
# 943 "/Users/shi-rongliu/tool/neovim-master/src/nvim/eval/decode.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT
{
  switch (mobj.type) {
    ...
    case MSGPACK_OBJECT_POSITIVE_INTEGER: {
      if (mobj.via.u64 <= 9223372036854775807LL) {
        *rettv = (typval_T) {
          .v_type = VAR_NUMBER,
          .v_lock = VAR_UNLOCKED,
    ...
    case MSGPACK_OBJECT_NEGATIVE_INTEGER: {
      if (mobj.via.i64 >= (-9223372036854775807LL -1)) {
        *rettv = (typval_T) {
          .v_type = VAR_NUMBER,
          .v_lock = VAR_UNLOCKED,
    ...
    case MSGPACK_OBJECT_STR: {
      *rettv = decode_string(mobj.via.bin.ptr, mobj.via.bin.size, kTrue, 0,
                             0);
    ...
    case MSGPACK_OBJECT_BIN: {
      *rettv = decode_string(mobj.via.bin.ptr, mobj.via.bin.size, kNone, 1,
                             0);
      if (rettv->v_type == VAR_UNKNOWN) {
        return 0;
      }
