# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2



# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stdbool.h" 1 3
# 5 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.h" 2
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memline.h" 1
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/move.h" 1
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 18 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 20 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
# 21 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c" 2
...
int getviscol2(colnr_T col, colnr_T coladd)
{
  ...
  pos.col = col;
  pos.coladd = coladd;
  getvvcol(curwin, &pos, &x, ((void*)0), ((void*)0));
  return (int)x;
}
...
{
  int rc = coladvance2(&curwin->w_cursor, 1, 0, wcol);
...
# 80 "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c"
...
)
{
  ...
  line = ml_get_buf(curbuf, pos->lnum, 0);
  ...
  if (wcol >= MAXCOL) {
    ...
    if (virtual_active()
      ...
      if (line[idx] == '\000') {
        ...
        size_t newline_size;
        do { if (__builtin_add_overflow(idx, correct, &newline_size)) { logmsg(4, ((void*)0), __func__, 178, 1, "STRICT_ADD overflow"); abort(); } } while (0);
        char_u *newline = xmallocz(newline_size);
        __builtin___memcpy_chk (newline, line, (size_t)idx, __builtin_object_size (newline, 0));
        __builtin___memset_chk (newline + idx, ' ', (size_t)correct, __builtin_object_size (newline + idx, 0));

        ml_replace(pos->lnum, newline, 0);
        ...
        size_t n;
        do { if (__builtin_add_overflow(linelen - 1, csize, &n)) { logmsg(4, ((void*)0), __func__, 197, 1, "STRICT_ADD overflow"); abort(); } } while (0);
        newline = xmallocz(n);

        __builtin___memcpy_chk (newline, line, (size_t)idx, __builtin_object_size (newline, 0));

        __builtin___memset_chk (newline + idx, ' ', (size_t)csize, __builtin_object_size (newline + idx, 0));

        do { if (__builtin_sub_overflow(linelen, idx, &n)) { logmsg(4, ((void*)0), __func__, 204, 1, "STRICT_SUB overflow"); abort(); } } while (0);
        do { if (__builtin_sub_overflow(n, 1, &n)) { logmsg(4, ((void*)0), __func__, 205, 1, "STRICT_SUB overflow"); abort(); } } while (0);
        __builtin___memcpy_chk (newline + idx + csize, line + idx + 1, n, __builtin_object_size (newline + idx + csize, 0));
  ...
  if (finetune) {
    if (wcol == MAXCOL) {
      ...
      if (!one_more) {
        ...
        getvcol(curwin, pos, &scol, ((void*)0), &ecol);
...
{
  return coladvance2(pos, 0, virtual_active(), wcol);
}
...
linenr_T get_cursor_rel_lnum(win_T *wp, linenr_T lnum)
{
  ...
  for (; from_line < to_line; from_line++, retval++) {
    ...
    (void)hasFoldingWin(wp, from_line, ((void*)0), &from_line, 1, ((void*)0));
  }
...
void check_pos(buf_T *buf, pos_T *pos)
{
  ...
  if (pos->col > 0) {
     line = ml_get_buf(buf, pos->lnum, 0);
...
void check_cursor_col_win(win_T *win)
{
  ...
  len = (colnr_T)strlen((char *)(ml_get_buf(win->w_buffer, win->w_cursor.lnum, 0)));
  if (len == 0) {
    win->w_cursor.col = 0;
  ...
  if (oldcol == MAXCOL) {
    ...
    if (oldcoladd > win->w_cursor.col) {
      ...
      if (win->w_cursor.col + 1 < len) {
        (__builtin_expect(!(win->w_cursor.coladd > 0), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/cursor.c", 398, "win->w_cursor.coladd > 0") : (void)0);
        int cs, ce;

        getvcol(win, &win->w_cursor, &cs, ((void*)0), &ce);
...
{
  return ml_get_buf(curbuf, curwin->w_cursor.lnum, 0);
}
