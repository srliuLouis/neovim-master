# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c" 2
...
# 6 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.h" 2
...
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.h" 2
...
extern int kCtxAll;
# 7 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c" 2
...
# 8 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c" 2
...
static ContextVec ctx_stack = { .size = 0, .capacity = 0, .items = ((void*)0) };
...
# 78 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c"
void ctx_save(Context *ctx, const int flags)
{
  if (ctx == ((void*)0)) {
    (*((((ctx_stack).size == (ctx_stack).capacity) ? (((ctx_stack).capacity = ((ctx_stack).capacity ? (ctx_stack).capacity << 1 : 8), (ctx_stack).items = xrealloc((ctx_stack).items, sizeof((ctx_stack).items[0]) * (ctx_stack).capacity)), 0) : 0), ((ctx_stack).items + ((ctx_stack).size++))) = ((Context) { .regs = (msgpack_sbuffer) { .size = 0, .data = ((void*)0), .alloc = 0, }, .jumps = (msgpack_sbuffer) { .size = 0, .data = ((void*)0), .alloc = 0, }, .bufs = (msgpack_sbuffer) { .size = 0, .data = ((void*)0), .alloc = 0, }, .gvars = (msgpack_sbuffer) { .size = 0, .data = ((void*)0), .alloc = 0, }, .funcs = {.size = 0, .capacity = 0, .items = ((void*)0)}, }));
  ...
  if (flags & kCtxFuncs) {
    ctx_save_funcs(ctx, 0);
  } else if (flags & kCtxSFuncs) {
    ctx_save_funcs(ctx, 1);
  }
}
# 117 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c"
_Bool ctx_restore(Context *ctx, const int flags)
{
  ...
  char_u *op_shada;
  get_option_value("shada", ((void*)0), &op_shada, OPT_GLOBAL);
...
static inline void ctx_save_funcs(Context *ctx, _Bool scriptonly)
  FUNC_ATTR_NONNULL_ALL
{
  ctx->funcs = (Array){.size = 0, .capacity = 0, .items = ((void*)0)};
  Error err = { .type = kErrorTypeNone, .msg = ((void*)0) };

  do { hashtab_T *const hiht_ = (&func_hashtab); size_t hitodo_ = hiht_->ht_used; for (hashitem_T *hi = hiht_->ht_array; hitodo_; hi++) { if (!((hi)->hi_key == ((void*)0) || (hi)->hi_key == (char_u *)&hash_removed)) { hitodo_--; { { const char_u *const name = hi->hi_key; _Bool islambda = (strncmp((char *)(name), (char *)("<lambda>"), (size_t)(8)) == 0); _Bool isscript = (name[0] == (0x80)); if (!islambda && (!scriptonly || isscript)) { size_t cmd_len = sizeof("func! ") + strlen((char *)(name)); char *cmd = xmalloc(cmd_len); __builtin___snprintf_chk (cmd, cmd_len, 0, __builtin_object_size (cmd, 1 > 1 ? 1 : 0), "func! %s", name); String func_body = nvim_exec(cstr_as_string(cmd), 1, &err); xfree(cmd); if (!((&err)->type != kErrorTypeNone)) { (*((((ctx->funcs).size == (ctx->funcs).capacity) ? (((ctx->funcs).capacity = ((ctx->funcs).capacity ? (ctx->funcs).capacity << 1 : 8), (ctx->funcs).items = xrealloc((ctx->funcs).items, sizeof((ctx->funcs).items[0]) * (ctx->funcs).capacity)), 0) : 0), ((ctx->funcs).items + ((ctx->funcs).size++))) = (((Object) { .type = kObjectTypeString, .data.string = func_body }))); } api_clear_error(&err); } } } } } } while (0);
# 265 "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c"
}
...
static inline msgpack_sbuffer array_to_sbuf(Array array)
{
  ...
  if (!encode_vim_list_to_buf(list_tv.vval.v_list, &sbuf.size, &sbuf.data)) {
    emsg((char_u *)(libintl_gettext((char *)("E474: Failed to convert list to msgpack string buffer"))));
  }
...
Dictionary ctx_to_dict(Context *ctx)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(ctx != ((void*)0)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c", 334, "ctx != NULL") : (void)0);
...
int ctx_from_dict(Dictionary dict, Context *ctx)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(ctx != ((void*)0)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/context.c", 356, "ctx != NULL") : (void)0);
