# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/12.0.0/include/stdbool.h" 1 3
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 18 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 19 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 20 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/highlight.h" 1
# 21 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 24 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.h" 1
# 25 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ugrid.h" 1
...
# 26 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 27 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 28 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 29 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
...
# 30 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/os/os.h" 1
# 31 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c" 2





static UI *compositor = ((void*)0);
static int composed_uis = 0;
struct { size_t size; size_t capacity; ScreenGrid * *items; } layers = { .size = 0, .capacity = 0, .items = ((void*)0) };
...
static _Bool valid_screen = 1;
static int msg_current_row = 2147483647;
static _Bool msg_was_scrolled = 0;
...
void ui_comp_init(void)
{
  ...
  compositor->width = 2147483647;
  compositor->height = 2147483647;
  for (UIExtension i = 0; (int)i < kUIExtCount; i++) {
    compositor->ui_ext[i] = 1;
  }



  compositor->ui_ext[kUIHlState] = 0;
...
void ui_comp_detach(UI *ui)
{
  composed_uis--;
  if (composed_uis == 0) {
    do { void **ptr_ = (void **)&(linebuf); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
    do { void **ptr_ = (void **)&(attrbuf); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
    bufsize = 0;
  }
  ui->composed = 0;
}
...
_Bool ui_comp_put_grid(ScreenGrid *grid, int row, int col, int height, int width,
                      _Bool valid, _Bool on_top)
{
  _Bool moved;
  ...
  if (grid->comp_index != 0) {
    ...
    if (ui_comp_should_draw()) {
      ...
      grid->comp_disabled = 1;
      compose_area(grid->comp_row, row,
                   grid->comp_col, grid->comp_col + grid->Columns);
      if (grid->comp_col < col) {
        compose_area((((row)>(grid->comp_row))?(row):(grid->comp_row)),
                     (((row+height)<(grid->comp_row+grid->Rows))?(row+height):(grid->comp_row+grid->Rows)),
                     grid->comp_col, col);
      }
...
# 174 "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c"
    size_t insert_at = ((layers).size);
    _Bool cmd_completion = (grid == &pum_grid && (State & 0x08)
                           && (wop_flags & 0x02));
...
{
  (__builtin_expect(!(grid != &default_grid), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c", 207, "grid != &default_grid") : (void)0);
  if (grid->comp_index == 0) {
...
static void ui_comp_raise_grid(ScreenGrid *grid, size_t new_index)
{
  ...
  for (size_t i = old_index; i < new_index; i++) {
    ...
    int startcol = (((grid->comp_col)>(grid2->comp_col))?(grid->comp_col):(grid2->comp_col));
    int endcol = (((grid->comp_col+grid->Columns)<(grid2->comp_col+grid2->Columns))?(grid->comp_col+grid->Columns):(grid2->comp_col+grid2->Columns));

    compose_area((((grid->comp_row)>(grid2->comp_row))?(grid->comp_row):(grid2->comp_row)),
                 (((grid->comp_row+grid->Rows)<(grid2->comp_row+grid2->Rows))?(grid->comp_row+grid->Rows):(grid2->comp_row+grid2->Rows)),
                 startcol, endcol);
  }
}
                                     ...
                                     Integer r, Integer c)
{
  ...
  if (curgrid != &default_grid) {
    ...
    if (((layers).items[(new_index)]) == &msg_grid) {
      new_index--;
    }
                         ...
                         LineFlags flags)
{
  ...
  while (col < endcol) {
    ...
    for (size_t i = 0; i < ((layers).size); i++) {
      ...
      grid_width = (((g->Columns)<(g->comp_width))?(g->Columns):(g->comp_width));
      grid_height = (((g->Rows)<(g->comp_height))?(g->Rows):(g->comp_height));
      ...
      if (g->comp_col <= col && col < g->comp_col + grid_width) {
        ...
        until = (((until)<(g->comp_col))?(until):(g->comp_col));
      }
    }
    until = (((until)<((int)endcol))?(until):((int)endcol));

    (__builtin_expect(!(grid != ((void*)0)), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c", 366, "grid != NULL") : (void)0);
    (__builtin_expect(!(until > col), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c", 367, "until > col") : (void)0);
    (__builtin_expect(!(until <= default_grid.Columns), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c", 368, "until <= default_grid.Columns") : (void)0);
    ...
    if (row == msg_sep_row && grid->comp_index <= msg_grid.comp_index) {
      ...
      for (int i = col; i < until; i++) {
        __builtin___memcpy_chk (linebuf[i-startcol], msg_sep_char, sizeof(*linebuf), __builtin_object_size (linebuf[i-startcol], 0));
        attrbuf[i-startcol] = msg_sep_attr;
      }
    } else {
      size_t off = grid->line_offset[row-grid->comp_row]
                   + (size_t)(col-grid->comp_col);
      __builtin___memcpy_chk (linebuf+(col-startcol), grid->chars+off, n * sizeof(*linebuf), __builtin_object_size (linebuf+(col-startcol), 0));
      __builtin___memcpy_chk (attrbuf+(col-startcol), grid->attrs+off, n * sizeof(*attrbuf), __builtin_object_size (attrbuf+(col-startcol), 0));
    ...
    if (grid->blending) {
      ...
      for (int i = col-(int)startcol; i < until-startcol; i += width) {
        ...
        _Bool thru = strequal((char *)linebuf[i], " ") && bg_line[i][0] != '\000';
        ...
        if (thru) {
          __builtin___memcpy_chk (linebuf + i, bg_line + i, (size_t)width * sizeof(linebuf[i]), __builtin_object_size (linebuf + i, 0));
        }
      }
    }
  ...
  (__builtin_expect(!(endcol <= chk_width), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c", 435, "endcol <= chk_width") : (void)0);
  (__builtin_expect(!(row < chk_height), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c", 436, "row < chk_height") : (void)0);
...
static void compose_debug(Integer startrow, Integer endrow, Integer startcol,
                          Integer endcol, int syn_id, _Bool delay)
{
  if (!(rdb_flags & 0x001)) {
    return;
  }

  endrow = (((endrow)<(default_grid.Rows))?(endrow):(default_grid.Rows));
  endcol = (((endcol)<(default_grid.Columns))?(endcol):(default_grid.Columns));
  int attr = syn_id2attr(syn_id);

  for (int row = (int)startrow; row < endrow; row++) {
    ui_composed_call_raw_line(1, row, startcol, startcol, endcol, attr, 0,
...
static void debug_delay(Integer lines)
{
  ...
  uint64_t factor = (uint64_t)((((((lines)<(5))?(lines):(5)))>(1))?((((lines)<(5))?(lines):(5))):(1));
  os_microdelay(factor * wd * 1000u, 1);
}
...
{
  compose_debug(startrow, endrow, startcol, endcol, dbghl_recompose, 1);
  endrow = (((endrow)<(default_grid.Rows))?(endrow):(default_grid.Rows));
  endcol = (((endcol)<(default_grid.Columns))?(endcol):(default_grid.Columns));
  if (endcol <= startcol) {
    return;
                             ...
                             const sattr_T *attrs)
{
  ...
  (__builtin_expect(!(endcol <= clearcol), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c", 535, "endcol <= clearcol") : (void)0);
  ...
  if (clearcol > default_grid.Columns) {
    ...
    endcol = (((endcol)<(clearcol))?(endcol):(clearcol));
  }

  _Bool covered = curgrid_covered_above((int)row);


  if (flags & kLineFlagInvalid || covered || curgrid->blending) {
    compose_debug(row, row+1, startcol, clearcol, dbghl_composed, 1);
    compose_line(row, startcol, clearcol, flags);
  } else {
    compose_debug(row, row+1, startcol, endcol, dbghl_normal, 0);
    compose_debug(row, row+1, endcol, clearcol, dbghl_clear, 1);

    for (int i = 0; i < endcol-startcol; i++) {
      (__builtin_expect(!(attrs[i] >= 0), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/ui_compositor.c", 565, "attrs[i] >= 0") : (void)0);
    }
                                ...
                                Boolean scrolled, String sep_char)
{
  ...
  if (row > msg_current_row && ui_comp_should_draw()) {
    compose_area((((msg_current_row-1)>(0))?(msg_current_row-1):(0)), row, 0, default_grid.Columns);
  } else if (row < msg_current_row && ui_comp_should_draw()
             && msg_current_row < Rows) {
    int delta = msg_current_row - (int)row;
    if (msg_grid.blending) {
      int first_row = ((((int)row-(scrolled?1:0))>(0))?((int)row-(scrolled?1:0)):(0));
      compose_area(first_row, Rows-delta, 0, Columns);
    } else {

      int first_row = ((((int)row-(msg_was_scrolled?1:0))>(0))?((int)row-(msg_was_scrolled?1:0)):(0));
...
{
  _Bool above_msg = (((layers).items[(((layers).size)-1)]) == &msg_grid
                                ...
                                Integer rows, Integer cols)
{
  ...
  _Bool covered = curgrid_covered_above((int)(bot - (((rows)>(0))?(rows):(0))));

  if (covered || curgrid->blending) {



    compose_debug(top, bot, left, right, dbghl_recompose, 1);
    for (int r = (int)(top + (((-rows)>(0))?(-rows):(0))); r < bot - (((rows)>(0))?(rows):(0)); r++) {
