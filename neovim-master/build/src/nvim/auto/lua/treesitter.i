# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 9 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 63 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk/usr/include/stdlib.h" 2 3 4
...
# 10 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 11 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 12 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 13 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 15 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 16 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 17 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 19 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2

# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.h" 1
# 21 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 22 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
# 1 "/Users/shi-rongliu/tool/neovim-master/src/nvim/memline.h" 1
# 23 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
# 24 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c" 2
...
{
  const char *lang_name = (luaL_checklstring(L, (1), ((void*)0)));
...
int tslua_add_language(lua_State *L)
{
  ...
  const char *lang_name = (luaL_checklstring(L, (2), ((void*)0)));
  ...
  char symbol_buf[128];
  __builtin___snprintf_chk (symbol_buf, 128, 0, __builtin_object_size (symbol_buf, 1 > 1 ? 1 : 0), "tree_sitter_%s", lang_name);


  uv_lib_t lib;
  if (uv_dlopen(path, &lib)) {
    __builtin___snprintf_chk ((char *)IObuff, (1024+1), 0, __builtin_object_size ((char *)IObuff, 1 > 1 ? 1 : 0), "Failed to load parser: uv_dlopen: %s", uv_dlerror(&lib));
  ...
  if (uv_dlsym(&lib, symbol_buf, (void **)&lang_parser)) {
    __builtin___snprintf_chk ((char *)IObuff, (1024+1), 0, __builtin_object_size ((char *)IObuff, 1 > 1 ? 1 : 0), "Failed to load parser: uv_dlsym: %s", uv_dlerror(&lib));
                            ...
                            TSPoint position, uint32_t *bytes_read)
{
  ...
  char_u *line = ml_get_buf(bp, position.row+1, 0);
  size_t len = strlen((char *)(line));
  if (position.column > len) {
    *bytes_read = 0;
    return "";
  }
  size_t tocopy = (((len-position.column)<(256))?(len-position.column):(256));

  __builtin___memcpy_chk (buf, line+position.column, tocopy, __builtin_object_size (buf, 0));
...
static int parser_parse(lua_State *L)
{
  ...
  TSTree *old_tree = ((void*)0);
  if (!(lua_type(L, (2)) == 0)) {
    TSTree **tmp = tree_check(L, 2);
    old_tree = tmp ? *tmp : ((void*)0);
  }

  TSTree *new_tree = ((void*)0);
  size_t len;
  const char *str;
  long bufnr;
  buf_T *buf;
  ...
  TSRange *changed = old_tree ? ts_tree_get_changed_ranges(
      old_tree, new_tree, &n_ranges) : ((void*)0);

  push_tree(L, new_tree, 0);
...
# 634 "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c"
static void push_node(lua_State *L, TSNode node, int uindex)
{
  (__builtin_expect(!(uindex > 0 || uindex < -20), 0) ? __assert_rtn(__func__, "/Users/shi-rongliu/tool/neovim-master/src/nvim/lua/treesitter.c", 636, "uindex > 0 || uindex < -LUA_MINSTACK") : (void)0);
...
static int node_field(lua_State *L)
{
  ...
  if (ts_tree_cursor_goto_first_child(&cursor)) {
    do {
      ...
      if (current_field != ((void*)0) && !strcmp((char *)(field_name), (char *)(current_field))) {
...
static int query_next_capture(lua_State *L)
{
  ...
  if (ud->predicated_match > -1) {
    ...
    _Bool active = lua_toboolean(L, -1);
    lua_settop(L, -(1)-1);
    if (!active) {
...
static int node_rawquery(lua_State *L)
{
  ...
  _Bool captures = lua_toboolean(L, 3);
...
int tslua_parse_query(lua_State *L)
{
  ...
  const char *lang_name = lua_tolstring(L, (1), ((void*)0));
  TSLanguage *lang = map_cstr_t_ptr_t_get(langs, lang_name);
  if (!lang) {
    return luaL_error(L, "no such language: %s", lang_name);
  }
